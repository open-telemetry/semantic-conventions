...
| Semantic Conventions: Service and Deployment | [semconv-service-and-deployment-approvers](https://github.com/orgs/open-telemetry/teams/semconv-service-and-deployment-approvers) | https://github.com/open-telemetry/community/blob/main/projects/service-and-deployment-semconv.md | https://github.com/orgs/open-telemetry/projects/168 | `area:service`, `area:deployment`, `area:data` | `accepting_contributions`, `active` | The SIG is looking for contributions! |
