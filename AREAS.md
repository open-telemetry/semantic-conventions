...
| Semantic Conventions: RPC | [semconv-rpc-approvers](https://github.com/orgs/open-telemetry/teams/semconv-rpc-approvers) | https://github.com/open-telemetry/community/blob/main/projects/rpc-semconv.md | https://github.com/orgs/open-telemetry/projects/161 | `area:rpc`, `area:jsonrpc`, `area:grpc` | `accepting_contributions`, `active` | The SIG is looking for contributions! |
