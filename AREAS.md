...
| Semantic Conventions: RPC |  | https://github.com/open-telemetry/community/blob/main/projects/rpc-semconv.md | https://github.com/orgs/open-telemetry/projects/161 | `area:rpc`, `area:jsonrpc` | `accepting_contributions`, `active` | The SIG is looking for contributions! |
