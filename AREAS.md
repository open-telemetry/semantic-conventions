...
> contributing guide for the bypass procedure for legitimate bug fixes.
...
| Semantic Conventions: Ruby | [ruby-approvers](https://github.com/orgs/open-telemetry/teams/ruby-approvers) | N/A | N/A | `area:rails`, `area:ruby` | `accepting_contributions`, `active` | The SIG is looking for contributions! |
...
| Semantic Conventions: Mainframe | [semconv-mainframe-approvers](https://github.com/orgs/open-telemetry/teams/semconv-mainframe-approvers) | https://github.com/open-telemetry/community/blob/main/projects/mainframe.md | N/A | `area:mainframe`, `area:zos` | `accepting_contributions`, `active` | The SIG is looking for contributions! |
...
| Semantic Conventions: Network | [semconv-network-approvers](https://github.com/orgs/open-telemetry/teams/semconv-network-approvers) | https://github.com/open-telemetry/community/blob/main/projects/network.md | https://github.com/orgs/open-telemetry/projects/202 | `area:network`, `area:source`, `area:destination`, `area:dns` | `accepting_contributions`, `active` | The SIG is looking for contributions! |
<!-- endareas -->
