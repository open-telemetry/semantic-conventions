...
| Name | Instrument Type ([*](/semantic_conventions/general/metrics-general.md#instrument-types)) | Unit | Unit ([UCUM](/semantic_conventions/general/metrics-general.md#instrument-units)) | Description | Status | Streaming |
|------|------------|------|-------------------------------------------|-------------|--------|-----------|
...
[network.transport]: /semantic_conventions/general/general-attributes.md#network-attributes
