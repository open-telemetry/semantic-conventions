...
[network attributes]: /semantic_conventions/general/general-attributes.md#server-and-client-attributes
[`service.name`]: /semantic_conventions/resource/README.md#service
[`peer.service`]: /semantic_conventions/general/general-attributes.md#general-remote-service-attributes
...
HTTP calls can generally be represented using just [HTTP spans](/semantic_conventions/http/http-spans.md).
