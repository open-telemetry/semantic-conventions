...
metric](/semantic_conventions/general/metrics-general.md#general-metric-semantic-conventions), [system
...
conventions](/semantic_conventions/general/metrics-general.md#general-metric-semantic-conventions). Authors of
...
[`process.runtime`](/semantic_conventions/resource/process.md#process-runtimes) resource attributes SHOULD be included on runtime metric events as appropriate.
