...
metrics in OpenTelemetry. Consider the [general metric semantic conventions](/semantic_conventions/general/metrics-general.md#general-metric-semantic-conventions)
...
All metrics in `hw.` instruments should be attached to a [Host Resource](/semantic_conventions/resource/host.md)
...
| Name        | Description                                                                        | Units   | Instrument Type ([*](/semantic_conventions/general/metrics-general.md#instrument-types)) | Value Type | Attribute Key(s)              | Attribute Values           |
| ----------- | ---------------------------------------------------------------------------------- | ------- | ------------------------------------------------- | ---------- | ----------------------------- | -------------------------- |
...
| Name                 | Description                                                                   | Units   | Instrument Type ([*](/semantic_conventions/general/metrics-general.md#instrument-types)) | Value Type | Attribute Key              | Attribute Values                                |
| -------------------- | ----------------------------------------------------------------------------- | ------- | ------------------------------------------------- | ---------- | -------------------------- | ----------------------------------------------- |
