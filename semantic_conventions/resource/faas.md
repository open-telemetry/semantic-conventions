...
- The [Trace semantic conventions for FaaS](/semantic_conventions/faas/faas-spans.md)
...
Note: The resource attribute `faas.instance` differs from the span attribute `faas.invocation_id`. For more information see the [Semantic conventions for FaaS spans](/semantic_conventions/faas/faas-spans.md#difference-between-invocation-and-instance).
...
attribute instead.
See the [FaaS trace conventions](/semantic_conventions/faas/faas-spans.md) for more.
