...
For Apache Kafka producers, [`peer.service`](/semantic_conventions/general/general-attributes.md#general-remote-service-attributes) SHOULD be set to the name of the broker or service the message will be sent to.
...
| Name                                         | Instrument    | Value type | Unit   | Unit ([UCUM](/semantic_conventions/general/metrics-general.md#instrument-units)) | Description    | Attribute Key | Attribute Values |
| ---------------------------------------------| ------------- | ---------- | ------ | -------------------------------------------- | -------------- | ------------- | ---------------- |
