...
Lambda largely follows the conventions for [FaaS][faas] while [HTTP](/semantic_conventions/http/http-spans.md) conventions are also
...
<!-- Re-generate TOC with `markdown-toc --no-first-h1 -i semantic_conventions/faas/aws-lambda.md` -->
...
[faasres]: /semantic_conventions/resource/faas.md (FaaS resource conventions)
[cloud]: /semantic_conventions/resource/cloud.md (Cloud resource conventions)
...
The Lambda span name and the [`http.route` span attribute](/semantic_conventions/http/http-spans.md#http-server-semantic-conventions) SHOULD
...
[`faas.trigger`][faas] MUST be set to `http`. [HTTP attributes](/semantic_conventions/http/http-spans.md) SHOULD be set based on the
...
- [`messaging.operation`](/semantic_conventions/messaging/messaging-spans.md) MUST be set to `process`.
- [`messaging.system`](/semantic_conventions/messaging/messaging-spans.md) MUST be set to `AmazonSQS`.
- [`messaging.destination.kind` or `messaging.source.kind`](/semantic_conventions/messaging/messaging-spans.md#messaging-attributes) MUST be set to `queue`.
...
- [`faas.trigger`][faas] MUST be set to `pubsub`.
- [`messaging.operation`](/semantic_conventions/messaging/messaging-spans.md#messaging-attributes) MUST be set to `process`.
- [`messaging.system`](/semantic_conventions/messaging/messaging-spans.md#messaging-attributes) MUST be set to `AmazonSQS`.

Other [Messaging attributes](/semantic_conventions/messaging/messaging-spans.md#messaging-attributes) SHOULD be set based on the available information in the SQS message
event.
