...
The function responsibility is to provide an answer to an inbound HTTP request. The `faas` span SHOULD follow the recommendations described in the [HTTP Server semantic conventions](/semantic_conventions/http/http-spans.md#http-server-semantic-conventions).
...
following the [Messaging systems semantic conventions](/semantic_conventions/messaging/messaging-spans.md).
