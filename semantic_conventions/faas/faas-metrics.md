...
| Name                   | Instrument Type ([*](/semantic_conventions/general/metrics-general.md#instrument-types)) | Unit         | Unit ([UCUM](/semantic_conventions/general/metrics-general.md#instrument-units)) | Description                                                                  |
|------------------------|---------------------------------------------------|--------------|-------------------------------------------|------------------------------------------------------------------------------|
