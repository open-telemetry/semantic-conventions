...
* [Database](/semantic_conventions/database/database-metrics.md): For SQL and NoSQL client metrics.
* [FaaS](/semantic_conventions/faas/faas-metrics.md): For [Function as a Service](https://en.wikipedia.org/wiki/Function_as_a_service) metrics.
* [HTTP](/semantic_conventions/http/http-metrics.md): For HTTP client and server metrics.
* [RPC](/semantic_conventions/rpc/rpc-metrics.md): For RPC client and server metrics.
* **System metrics**
  * [System](/semantic_conventions/system/system-metrics.md): For standard system metrics.
  * [Hardware](/semantic_conventions/system/hardware-metrics.md): For hardware-related metrics.
  * [Process](/semantic_conventions/system/process-metrics.md): For standard process metrics.
  * [Runtime Environment](/semantic_conventions/system/runtime-environment-metrics.md): For runtime environment metrics.
...
their own [Resource Semantic Conventions](/semantic_conventions/resource/README.md).
