...
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `hw.energy` | Counter | `double` | `J` | Energy consumed by the component | ![Development](https://img.shields.io/badge/-development-blue) |  |
...
| Name     | Instrument Type | Value Type | Unit (UCUM) | Description    | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `hw.errors` | Counter | `int` | `{error}` | Number of errors encountered by the component | ![Development](https://img.shields.io/badge/-development-blue) |  |
...
| Name     | Instrument Type | Value Type | Unit (UCUM) | Description    | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `hw.power` | Gauge | `double` | `W` | Instantaneous power consumed by the component [1] | ![Development](https://img.shields.io/badge/-development-blue) |  |
...
| Name     | Instrument Type | Value Type | Unit (UCUM) | Description    | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `hw.status` | UpDownCounter | `int` | `1` | Operational status: `1` (true) or `0` (false) for each of the possible states [1] | ![Development](https://img.shields.io/badge/-development-blue) |  |
