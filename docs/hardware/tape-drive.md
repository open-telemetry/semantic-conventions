...
| [`hw.tape_drive.model`](/docs/registry/attributes/hardware.md) | string | Descriptive model name of the tape drive | `IBM Ultrium 8`; `LTO-8` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
| [`hw.tape_drive.serial_number`](/docs/registry/attributes/hardware.md) | string | Serial number of the tape drive | `TD123456789` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
| [`hw.tape_drive.vendor`](/docs/registry/attributes/hardware.md) | string | Vendor name of the tape drive | `IBM`; `HP`; `Quantum` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
...
| [`hw.parent`](/docs/registry/attributes/hardware.md) | string | Unique identifier of the parent component (typically the `hw.id` attribute of the enclosure, or disk controller) | `dellStorage_perc_0` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
| [`hw.tape_drive.model`](/docs/registry/attributes/hardware.md) | string | Descriptive model name of the tape drive | `IBM Ultrium 8`; `LTO-8` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
| [`hw.tape_drive.operation_type`](/docs/registry/attributes/hardware.md) | string | Type of tape drive operation | `mount`; `unmount`; `clean` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
| [`hw.tape_drive.serial_number`](/docs/registry/attributes/hardware.md) | string | Serial number of the tape drive | `TD123456789` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
| [`hw.tape_drive.vendor`](/docs/registry/attributes/hardware.md) | string | Vendor name of the tape drive | `IBM`; `HP`; `Quantum` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
