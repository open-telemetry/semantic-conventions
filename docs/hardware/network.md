...
- `network.io.direction` SHOULD be set to indicate the direction of the error, either `"receive"` or `"transmit"`.
...
- `network.io.direction` MUST be set to one of the following values:
