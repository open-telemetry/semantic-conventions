...
<!-- semconv metric.hw.enclosure.status -->
...
| [`hw.state`](/docs/registry/attributes/hardware.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Required` | string | The current state of the component [1] | `ok`; `degraded`; `failed`; `open` [(see all values)](#hw-state-values) |
| [`hw.type`](/docs/registry/attributes/hardware.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Required` | string | Type of the component [2] | `enclosure` [(see all values)](#hw-type-values) |
...
**[2] `hw.type`:** MUST be set to `enclosure`.
