...
| [`hw.enclosure.bios_version`](/docs/registry/attributes/hardware.md) | string | BIOS version of the enclosure | `1.2.3` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
| [`hw.enclosure.model`](/docs/registry/attributes/hardware.md) | string | Descriptive model name of the enclosure | `PowerEdge R740` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
| [`hw.enclosure.serial_number`](/docs/registry/attributes/hardware.md) | string | Serial number of the enclosure | `CNFCP0123456789` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
| [`hw.enclosure.type`](/docs/registry/attributes/hardware.md) | string | Type of the enclosure (useful for modular systems) | `Computer`; `Storage`; `Switch` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
| [`hw.enclosure.vendor`](/docs/registry/attributes/hardware.md) | string | Vendor name of the enclosure | `Dell`; `HP`; `Lenovo` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
