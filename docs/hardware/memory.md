...
| [`hw.memory.model`](/docs/registry/attributes/hardware.md) | string | Descriptive model name of the memory module | `DDR4-3200`; `LPDDR5-6400` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
| [`hw.memory.serial_number`](/docs/registry/attributes/hardware.md) | string | Serial number of the memory module | `123456789ABC` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
...
| [`hw.memory.vendor`](/docs/registry/attributes/hardware.md) | string | Vendor name of the memory module | `Crucial`; `Kingston`; `Samsung`; `Corsair` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
