...
<!-- semconv metric_attributes.hw.memory -->
...
| [`hw.memory.type`](attributes/hardware.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | Type of the memory module | `DDR4`; `DDR5`; `LPDDR5` |
