...
<!-- semconv metric.otel.sdk.live_spans -->
...
| -------- | --------------- | ----------- | -------------- | --------- |
| `otel.sdk.live_spans` | UpDownCounter | `{span}` | The number of created spans for which the end operation has not been called yet [1] | ![Development](https://img.shields.io/badge/-development-blue) |

**[1]:** For spans with `recording=true`: Implementations MUST record both `otel.sdk.live_spans` and `otel.sdk.ended_spans`.
For spans with `recording=false`: If implementations decide to record this metric, they MUST also record `otel.sdk.ended_spans`.
...
### Metric: `otel.sdk.ended_spans`

This metric is [recommended][MetricRecommended].

<!-- semconv metric.otel.sdk.ended_spans -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
<!-- markdownlint-capture -->
...
| Name     | Instrument Type | Unit (UCUM) | Description    | Stability |
| -------- | --------------- | ----------- | -------------- | --------- |
| `otel.sdk.ended_spans` | Counter | `{span}` | The number of created spans for which the end operation was called [1] | ![Development](https://img.shields.io/badge/-development-blue) |

**[1]:** For spans with `recording=true`: Implementations MUST record both `otel.sdk.live_spans` and `otel.sdk.ended_spans`.
For spans with `recording=false`: If implementations decide to record this metric, they MUST also record `otel.sdk.live_spans`.
