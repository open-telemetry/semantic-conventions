...
- [Span Metrics](#span-metrics)
  ...
  - [Metric: `otel.otel.sdk.processor.log.processed`](#metric-otelotelsdkprocessorlogprocessed)
  - [Metric: `otel.otel.sdk.exporter.log.inflight`](#metric-otelotelsdkexporterloginflight)
  - [Metric: `otel.otel.sdk.exporter.log.exported`](#metric-otelotelsdkexporterlogexported)
...
### Metric: `otel.otel.sdk.processor.log.processed`
...
### Metric: `otel.otel.sdk.exporter.log.inflight`
...
### Metric: `otel.otel.sdk.exporter.log.exported`
