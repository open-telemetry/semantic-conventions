...
- [Span Metrics](#span-metrics)
  ...
  - [Metric: `otel.otel.sdk.processor.log.processed_logs`](#metric-otelotelsdkprocessorlogprocessed_logs)
  - [Metric: `otel.otel.sdk.exporter.log.inflight_logs`](#metric-otelotelsdkexporterloginflight_logs)
  - [Metric: `otel.otel.sdk.exporter.log.exported_logs`](#metric-otelotelsdkexporterlogexported_logs)
...
### Metric: `otel.otel.sdk.processor.log.processed_logs`

This metric is [recommended][MetricRecommended].

<!-- semconv metric.otel.sdk.processor.log.processed_logs -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
<!-- markdownlint-capture -->
...
| Name     | Instrument Type | Unit (UCUM) | Description    | Stability |
| -------- | --------------- | ----------- | -------------- | --------- |
| `otel.sdk.processor.log.processed_logs` | Counter | `{LogRecord}` | The number of LogRecords for which the processing has finished, either successful or failed [1] | ![Development](https://img.shields.io/badge/-development-blue) |
...
### Metric: `otel.otel.sdk.exporter.log.inflight_logs`

This metric is [recommended][MetricRecommended].

<!-- semconv metric.otel.sdk.exporter.log.inflight_logs -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
<!-- markdownlint-capture -->
...
| Name     | Instrument Type | Unit (UCUM) | Description    | Stability |
| -------- | --------------- | ----------- | -------------- | --------- |
| `otel.sdk.exporter.log.inflight_logs` | UpDownCounter | `{LogRecord}` | The number of LogRecords which were passed to the exporter, but that have not been exported yet (neither successful, nor failed) [1] | ![Development](https://img.shields.io/badge/-development-blue) |
...
### Metric: `otel.otel.sdk.exporter.log.exported_logs`

This metric is [recommended][MetricRecommended].

<!-- semconv metric.otel.sdk.exporter.log.exported_logs -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
<!-- markdownlint-capture -->
...
| Name     | Instrument Type | Unit (UCUM) | Description    | Stability |
| -------- | --------------- | ----------- | -------------- | --------- |
| `otel.sdk.exporter.log.exported_logs` | Counter | `{LogRecord}` | The number of LogRecords for which the export has finished, either successful or failed [1] | ![Development](https://img.shields.io/badge/-development-blue) |
