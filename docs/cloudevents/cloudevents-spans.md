...
| [`cloudevents.data_content_type`](/docs/registry/attributes/cloudevents.md) | string | The [data content type](https://github.com/cloudevents/spec/blob/v1.0.2/cloudevents/spec.md#datacontenttype) of the event in the context of the event producer (identified by source). | `application/json` | `Opt-In` | ![Development](https://img.shields.io/badge/-development-blue) |
