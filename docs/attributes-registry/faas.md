...
| `faas.invoked_name` | string | The name of the invoked function. [2] | 
my-function | ![Experimental](https://img.shields.io/badge/-experimental-blue) |
| `faas.invoked_provider` | string | The cloud provider of the invoked function. [3] | `alibaba_cloud`; `aws`; `azure`; `gcp`; `tencent_cloud` | ![Experimental](https://img.shields.io/badge/-experimental-blue) |
| `faas.invoked_region` | string | The cloud region of the invoked function. [4] | 
eu-central-1 | ![Experimental](https://img.shields.io/badge/-experimental-blue) |
| `faas.max_memory` | int | The amount of memory available to the serverless function converted to Bytes. [5] | 
