...
| <a id="zos-sysplex" href="#zos-sysplex">`zos.sysplex`</a> | string | The name of the SYSPLEX to which the z/OS system belongs too. | `SYSPLEX1` | ![Development](https://img.shields.io/badge/-development-blue) |
