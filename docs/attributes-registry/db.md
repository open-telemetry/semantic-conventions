...
| `db.elasticsearch.node.name` | string | Deprecated, use `db.instance.id` instead. [7]                                                | `instance-0000000001`                                                   | ![Deprecated](https://img.shields.io/badge/-deprecated-red)<br>Replaced by `db.instance.id`.                     |
