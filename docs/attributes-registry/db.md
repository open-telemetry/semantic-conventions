...
| <a id="db-cosmosdb-regions-contacted" href="#db-cosmosdb-regions-contacted">`db.cosmosdb.regions_contacted`</a> | string[] | Comma Separated List of regions contacted during operation in the order specific region was contacted. [10] | `["North Central US", "Australia East, Australia Southeast"]` | ![Experimental](https://img.shields.io/badge/-experimental-blue) |
...
**[10]:** Region name matches the format of `displayName` in [Azure Location API](https://learn.microsoft.com/rest/api/subscription/subscriptions/list-locations?view=rest-subscription-2021-10-01&tabs=HTTP#location)
