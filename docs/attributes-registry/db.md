...
| `db.operation.name` | string | The name of the operation being executed. [2] | `findAndModify`; `HMSET`; `SELECT` | ![Experimental](https://img.shields.io/badge/-experimental-blue) |
