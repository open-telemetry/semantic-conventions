...
| `db.response.row_count`          | int    | Number of rows returned by the database in response to a query.                                                                                                                                                                                                                                                                                                                                                                                                                             | `10`; `30`; `1000`                                                    | ![Experimental](https://img.shields.io/badge/-experimental-blue) |
