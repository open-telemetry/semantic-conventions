...
| `db.query.parameter.<key>` | string | The query parameters, `<key>` being the parameter name, the value being the parameter value. [3] | `someval`; `55` | ![Experimental](https://img.shields.io/badge/-experimental-blue) |
