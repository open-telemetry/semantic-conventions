...
| <a id="db-cosmosdb-regions-contacted" href="#db-cosmosdb-regions-contacted">`db.cosmosdb.regions_contacted`</a> | string[] | Comma separated list of regions contacted by the Azure Cosmos DB operation. | `["North Central US"]` | ![Experimental](https://img.shields.io/badge/-experimental-blue) |
