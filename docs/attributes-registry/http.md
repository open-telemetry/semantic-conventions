...
| <a id="http-sse-events-avg-interval" href="#http-sse-events-avg-interval">`http.sse.events.avg_interval`</a> | int | The average interval time in milliseconds among responded events. | `420` | ![Development](https://img.shields.io/badge/-development-blue) |
| <a id="http-sse-events-count" href="#http-sse-events-count">`http.sse.events.count`</a> | int | The number of responded events. | `42` | ![Development](https://img.shields.io/badge/-development-blue) |
| <a id="http-sse-events-max-interval" href="#http-sse-events-max-interval">`http.sse.events.max_interval`</a> | int | The maximum interval time in milliseconds among responded events. | `12138` | ![Development](https://img.shields.io/badge/-development-blue) |
| <a id="http-sse-events-min-interval" href="#http-sse-events-min-interval">`http.sse.events.min_interval`</a> | int | The minimum interval time in milliseconds among responded events. | `7` | ![Development](https://img.shields.io/badge/-development-blue) |
...
| <a id="http-response-content-length" href="#http-response-content-length">`http.response_content_length`</a> | int | Deprecated, use `http.response.header.content-length` instead. | `3495` | ![Deprecated](https://img.shields.io/badge/-deprecated-red)<br>hp.response.header.content-length |
