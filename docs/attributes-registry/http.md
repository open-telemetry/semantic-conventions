...
| <a id="http-request-header" href="#http-request-header">`http.request.header.<key>`</a> | template[string[]] | HTTP request headers, `<key>` being the normalized HTTP Header name (lowercase), the value being the header values. [1] | `["application/json"], ["1.2.3.4", "1.2.3.5"]` | ![Stable](https://img.shields.io/badge/-stable-lightgreen) |
...
| <a id="http-response-header" href="#http-response-header">`http.response.header.<key>`</a> | template[string[]] | HTTP response headers, `<key>` being the normalized HTTP Header name (lowercase), the value being the header values. [4] | `["application/json"]`; `["abc", "def"]` | ![Stable](https://img.shields.io/badge/-stable-lightgreen) |
