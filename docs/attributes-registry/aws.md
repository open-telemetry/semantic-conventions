...
| Attribute  | Type | Description  | Examples  | Stability |
|---|---|---|---|---|
| `aws.log.group.names` | string[] | The name(s) of the AWS log group(s) an application is writing to. [1] |`/aws/lambda/my-function`; `opentelemetry-service` | ![Experimental](https://img.shields.io/badge/-experimental-blue) |
...
[4]: This may be different from `cloud.resource_id` if an alias is involved.
