...
| `process.entity_id` | string | A globally unique identifier of the process. [1] | `903b0daafe95e8ed9c9c0c9070259c29` | ![Experimental](https://img.shields.io/badge/-experimental-blue) |
...
**[1]:** On Linux, where possible, it is RECOMMENDED that this is calculated with the following method.
The string `pid_starttime_bootid`, md5 hashed.
For example, `pid` - PID - "1001" `starttime` - start time in seconds from unix epoch - "1714153029" `bootid` - boot ID, as read from `/proc/sys/kernel/random/boot_id` - "16b6f4a4-179e-4480-9561-0df471d8c6d4"
md5("1001_1714153029_16b6f4a4-179e-4480-9561-0df471d8c6d4") -> "903b0daafe95e8ed9c9c0c9070259c29"
By following this method, the same entity_id will be generated by all observers of a given process. When using this method is not possible, `entity_id` can be any other type of GUID.
