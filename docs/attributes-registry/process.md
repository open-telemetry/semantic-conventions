...
| <a id="process-environment-variable" href="#process-environment-variable">`process.environment_variable.<key>`</a> | template[string] | Process environment variables, <key> being the environment variable name, the value being the environment variable value. | `ubuntu`; `/usr/local/bin:/usr/bin` | ![Development](https://img.shields.io/badge/-development-blue) |
