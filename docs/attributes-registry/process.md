...
| <a id="process-environment-variable-<key>" href="#process-environment-variable-<key>">`process.environment_variable.<key>`</a> | string | Process environment variables, <key> being the environment variable name, the value being the environment variable value. | `process.environment_variable.USER="ubuntu"`; `proccess.environment_variable.PATH="/usr/local/bin;/usr/bin"` | ![Development](https://img.shields.io/badge/-development-blue) |
