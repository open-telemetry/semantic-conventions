...
| <a id="rpc-streaming-messages-avg-interval" href="#rpc-streaming-messages-avg-interval">`rpc.streaming.messages.avg_interval`</a> | int | The average interval time in milliseconds among messages. | `420` | ![Development](https://img.shields.io/badge/-development-blue) |
| <a id="rpc-streaming-messages-count" href="#rpc-streaming-messages-count">`rpc.streaming.messages.count`</a> | int | The total number of streaming messages. | `42` | ![Development](https://img.shields.io/badge/-development-blue) |
| <a id="rpc-streaming-messages-max-interval" href="#rpc-streaming-messages-max-interval">`rpc.streaming.messages.max_interval`</a> | int | The maximum interval time in milliseconds among messages. | `12138` | ![Development](https://img.shields.io/badge/-development-blue) |
| <a id="rpc-streaming-messages-min-interval" href="#rpc-streaming-messages-min-interval">`rpc.streaming.messages.min_interval`</a> | int | The minimum interval time in milliseconds among messages. | `7` | ![Development](https://img.shields.io/badge/-development-blue) |
