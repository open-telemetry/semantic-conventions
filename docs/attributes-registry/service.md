...
|---|---|---|---|---|
| `service.name` | string | Logical name of the service. [1] |`shoppingcart` | ![Stable](https://img.shields.io/badge/-stable-lightgreen) |
...
| `service.namespace` | string | A namespace for `service.name`. [2] |`Shop` | ![Experimental](https://img.shields.io/badge/-experimental-blue) |
