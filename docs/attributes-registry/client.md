...
<a id="`client.address`"></a>

| [`client.address`](#`client.address`) | string | Client address - domain name if available without reverse DNS lookup; otherwise, IP address or Unix domain socket name. [1] | `client.example.com`; `10.1.2.80`; `/tmp/my.sock` | ![Stable](https://img.shields.io/badge/-stable-lightgreen) | |

### `client.port`

<a id="`client.port`"></a>

| [`client.port`](#`client.port`) | int | Client port number. [2] | `65123` | ![Stable](https://img.shields.io/badge/-stable-lightgreen) | |
