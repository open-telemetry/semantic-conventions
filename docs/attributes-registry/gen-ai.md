...
| `gen_ai.operation.name`          | string   | The name of the LLM operation request being made.                                                | `chat.completions`; `embeddings`; `speech.generations`; `audio.transcriptions`; `audio.translations`; `image.generations` | ![Experimental](https://img.shields.io/badge/-experimental-blue) |
