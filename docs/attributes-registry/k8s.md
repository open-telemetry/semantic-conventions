...
| <a id="k8s-node-annotation" href="#k8s-node-annotation">`k8s.node.annotation.<key>`</a> | string | The annotation key-value pairs placed on the Node. [3] | `0`; `` | ![Development](https://img.shields.io/badge/-development-blue) |
| <a id="k8s-node-label" href="#k8s-node-label">`k8s.node.label.<key>`</a> | string | The label key-value pairs placed on the Node. [4] | `arm64`; `` | ![Development](https://img.shields.io/badge/-development-blue) |
