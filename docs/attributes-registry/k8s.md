...
| <a id="k8s-cronjob-annotation" href="#k8s-cronjob-annotation">`k8s.cronjob.annotation.<key>`</a> | string | The annotation key-value pairs placed on the CronJob. [2] | `k8s.cronjob.annotation.retries=4`; `k8s.cronjob.annotation.data=` | ![Development](https://img.shields.io/badge/-development-blue) |
| <a id="k8s-cronjob-label" href="#k8s-cronjob-label">`k8s.cronjob.label.<key>`</a> | string | The label key-value pairs placed on the CronJob. [3] | `k8s.cronjob.label.type=weekly`; `k8s.cronjob.label.automated=` | ![Development](https://img.shields.io/badge/-development-blue) |
