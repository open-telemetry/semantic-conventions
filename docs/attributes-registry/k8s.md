...
| <a id="k8s-node-annotation" href="#k8s-node-annotation">`k8s.node.annotation.<key>`</a> | template[string] | The annotation key-value pairs placed on the Node. [3] | `0`; `` | ![Development](https://img.shields.io/badge/-development-blue) |
| <a id="k8s-node-label" href="#k8s-node-label">`k8s.node.label.<key>`</a> | template[string] | The label key-value pairs placed on the Node. [4] | `arm64`; `` | ![Development](https://img.shields.io/badge/-development-blue) |
...
| <a id="k8s-pod-annotation" href="#k8s-pod-annotation">`k8s.pod.annotation.<key>`</a> | template[string] | The annotation key-value pairs placed on the Pod, the `<key>` being the annotation name, the value being the annotation value. | `true`; `x64`; `` | ![Development](https://img.shields.io/badge/-development-blue) |
| <a id="k8s-pod-label" href="#k8s-pod-label">`k8s.pod.label.<key>`</a> | template[string] | The label key-value pairs placed on the Pod, the `<key>` being the label name, the value being the label value. | `my-app`; `x64`; `` | ![Development](https://img.shields.io/badge/-development-blue) |
...
| Attribute | Type | Description | Examples | Stability |
|---|---|---|---|---|
| <a id="k8s-pod-labels" href="#k8s-pod-labels">`k8s.pod.labels.<key>`</a> | template[string] | Deprecated, use `k8s.pod.label` instead. | `my-app` | ![Deprecated](https://img.shields.io/badge/-deprecated-red)<br>Replaced by `k8s.pod.label`. |
