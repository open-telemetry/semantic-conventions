...
linkTitle: .NET Remoting
--->

# Semantic conventions for .NET Remoting
...
The Semantic Conventions for [.NET Remoting](https://docs.microsoft.com/previous-versions/dotnet/netframework-3.0/72x4h507(v=vs.85)) extend and override the [RPC Semantic Conventions](README.md).

## Spans

### Client

<!-- semconv span.rpc.netframework_remoting.call.client -->
...
| [`rpc.response.status_code`](/docs/registry/attributes/rpc.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` if available. | string | The fully-qualified .NET exception type that was thrown by the .NET Remoting call, used as the status code. [3] | `OK`; `DEADLINE_EXCEEDED`; `-32602` |
...
**[3] `rpc.response.status_code`:** All non-empty status codes SHOULD be considered errors.
...
<!-- semconv span.rpc.netframework_remoting.call.server -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
.NET Remoting instrumentations SHOULD collect metrics according to the general
[Semantic Conventions for RPC Metrics](/docs/rpc/rpc-metrics.md).

`rpc.system.name` MUST be set to `"netframework_remoting"`.
