...
| [`server.port`](/docs/registry/attributes/server.md) | ![Stable](https://img.shields.io/badge/-stable-lightgreen) | `Recommended` If `server.address` is set. | int | Server port number. [5] | `20880`; `50051` |
...
**[5] `server.port`:** See the `server.address` for details on parsing the target string.
