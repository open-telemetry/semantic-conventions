...
| [`rpc.request.header.<key>`](/docs/registry/attributes/rpc.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | string[] | Dubbo request headers, carried as request attachments, `<key>` being the normalized header name (lowercase), the value being the values. [8] | `["1.2.3.4", "1.2.3.5"]` |
| [`rpc.response.trailer.<key>`](/docs/registry/attributes/rpc.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | string[] | Dubbo response trailers, carried as response attachments, `<key>` being the normalized trailer name (lowercase), the value being the values. [9] | `["attribute_value"]` |
