...
# Semantic Conventions for JSON-RPC Client and Server Spans
...
Semantic Conventions for [JSON-RPC](https://www.jsonrpc.org/) extend and override the [RPC client and server spans](rpc-spans.md)
