...
# Semantic Conventions for Connect RPC Client and Server Spans
...
Semantic Conventions for [Connect](http://connect.build) extend and override the [RPC client and server spans](rpc-spans.md).
