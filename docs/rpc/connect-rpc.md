...
| [`rpc.status_code`](/docs/registry/attributes/rpc.md) | string | The [error code](https://connectrpc.com//docs/protocol/#error-codes) of the Connect response. [3] | `OK`; `DEADLINE_EXCEEDED`; `-32602`; `404` | `Conditionally Required` if available. | ![Development](https://img.shields.io/badge/-development-blue) |
