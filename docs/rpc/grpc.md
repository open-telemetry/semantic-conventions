...
- [Spans](#spans)
  ...
  - [Server](#server)
- [Metrics](#metrics)
  - [Metric: `rpc.server.call.duration` (gRPC)](#metric-rpcservercallduration-grpc)
  - [Metric: `rpc.client.call.duration` (gRPC)](#metric-rpcclientcallduration-grpc)
...
### Metric: `rpc.server.call.duration` (gRPC)

This metric is [recommended][MetricRecommended].

This metric follows the common [`rpc.server.call.duration`](/docs/rpc/rpc-metrics.md#metric-rpcservercallduration)
definition.
...
<!-- semconv metric.rpc.grpc.server.call.duration -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `rpc.server.call.duration` | Histogram | `s` | Measures the duration of an incoming gRPC call. [1] | ![Release Candidate](https://img.shields.io/badge/-rc-mediumorchid) | |
...
| Key | Stability | [Requirement Level](https://opentelemetry.io/docs/specs/semconv/general/attribute-requirement-level/) | Value Type | Description | Example Values |
| --- | --- | --- | --- | --- | --- |
| [`rpc.status_code`](/docs/registry/attributes/rpc.md) | ![Release Candidate](https://img.shields.io/badge/-rc-mediumorchid) | `Required` | string | The string representation of the [status code](https://github.com/grpc/grpc/blob/v1.75.0/doc/statuscodes.md) returned by the server or generated by the gRPC library. [1] | `OK`; `DEADLINE_EXCEEDED`; `UNAVAILABLE` |
| [`rpc.system.name`](/docs/registry/attributes/rpc.md) | ![Release Candidate](https://img.shields.io/badge/-rc-mediumorchid) | `Required` | string | The Remote Procedure Call (RPC) system. [2] | `grpc`; `dubbo`; `connectrpc` |
| [`error.type`](/docs/registry/attributes/error.md) | ![Stable](https://img.shields.io/badge/-stable-lightgreen) | `Conditionally Required` If and only if the operation failed. | string | Describes a class of error the operation ended with. [3] | `UNKNOWN`; `DEADLINE_EXCEEDED`; `UNIMPLEMENTED`; `INTERNAL`; `UNAVAILABLE`; `DATA_LOSS` |
...
| [`server.address`](/docs/registry/attributes/server.md) | ![Stable](https://img.shields.io/badge/-stable-lightgreen) | `Opt-In` | string | A string identifying a group of RPC server instances request is sent to. [5] | `example.com`; `10.1.2.80`; `/tmp/my.sock` |
| [`server.port`](/docs/registry/attributes/server.md) | ![Stable](https://img.shields.io/badge/-stable-lightgreen) | `Opt-In` | int | Server port number. [6] | `50051` |
...
**[2] `rpc.system.name`:** The client and server RPC systems may differ for the same RPC interaction. For example, a client may use Apache Dubbo or Connect RPC to communicate with a server that uses gRPC since both protocols provide compatibility with gRPC.
...
**[5] `server.address`:** Instrumentations SHOULD populate `server.address` from the host
component of the HTTP/2 `:authority` pseudo-header the client used to
reach this server.
...
**[6] `server.port`:** Instrumentations SHOULD populate `server.port` from the port
component of the HTTP/2 `:authority` pseudo-header the client used to
reach this server.
...
### Metric: `rpc.client.call.duration` (gRPC)

This metric is [recommended][MetricRecommended].

This metric follows the common [`rpc.client.call.duration`](/docs/rpc/rpc-metrics.md#metric-rpcclientcallduration)
definition.
...
<!-- semconv metric.rpc.grpc.client.call.duration -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `rpc.client.call.duration` | Histogram | `s` | Measures the duration of an outgoing gRPC call. [1] | ![Release Candidate](https://img.shields.io/badge/-rc-mediumorchid) | |
...
| [`rpc.method`](/docs/registry/attributes/rpc.md) | ![Release Candidate](https://img.shields.io/badge/-rc-mediumorchid) | `Required` | string | The fully-qualified logical name of the method from the RPC interface perspective. [1] | `com.example.ExampleService/exampleMethod`; `EchoService/Echo`; `_OTHER` |
| [`rpc.status_code`](/docs/registry/attributes/rpc.md) | ![Release Candidate](https://img.shields.io/badge/-rc-mediumorchid) | `Required` | string | The string representation of the [status code](https://github.com/grpc/grpc/blob/v1.75.0/doc/statuscodes.md) returned by the server or generated by the client. [2] | `OK`; `DEADLINE_EXCEEDED`; `UNAVAILABLE` |
| [`rpc.system.name`](/docs/registry/attributes/rpc.md) | ![Release Candidate](https://img.shields.io/badge/-rc-mediumorchid) | `Required` | string | The Remote Procedure Call (RPC) system. [3] | `grpc`; `dubbo`; `connectrpc` |
| [`server.address`](/docs/registry/attributes/server.md) | ![Stable](https://img.shields.io/badge/-stable-lightgreen) | `Required` | string | A string identifying a group of RPC server instances request is sent to. [4] | `example.com`; `10.1.2.80`; `/tmp/my.sock` |
| [`error.type`](/docs/registry/attributes/error.md) | ![Stable](https://img.shields.io/badge/-stable-lightgreen) | `Conditionally Required` If and only if the operation failed. | string | Describes a class of error the operation ended with. [5] | `UNKNOWN`; `DEADLINE_EXCEEDED`; `UNIMPLEMENTED`; `INTERNAL`; `UNAVAILABLE`; `DATA_LOSS` |
| [`server.port`](/docs/registry/attributes/server.md) | ![Stable](https://img.shields.io/badge/-stable-lightgreen) | `Conditionally Required` [6] | int | Server port number. [7] | `50051` |
...
**[3] `rpc.system.name`:** The client and server RPC systems may differ for the same RPC interaction. For example, a client may use Apache Dubbo or Connect RPC to communicate with a server that uses gRPC since both protocols provide compatibility with gRPC.
...
**[7] `server.port`:** See the `server.address` for details on parsing the target string.
