...
| [`rpc.grpc.request.metadata.<key>`](/docs/attributes-registry/rpc.md) | template[string[]] | gRPC request metadata, `<key>` being the normalized gRPC Metadata key (lowercase), the value being the metadata values. [1] | `1.2.3.4`; `1.2.3.5` | `Opt-In` | ![Development](https://img.shields.io/badge/-development-blue) |
| [`rpc.grpc.response.metadata.<key>`](/docs/attributes-registry/rpc.md) | template[string[]] | gRPC response metadata, `<key>` being the normalized gRPC Metadata key (lowercase), the value being the metadata values. [2] | `attribute_value` | `Opt-In` | ![Development](https://img.shields.io/badge/-development-blue) |
