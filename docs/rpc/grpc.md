...
# Semantic Conventions for gRPC Client and Server Spans
...
Semantic Conventions for [gRPC](https://grpc.io/) extend and override the [RPC client and server spans](rpc-spans.md)
