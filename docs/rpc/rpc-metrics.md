...
| [`rpc.method`](/docs/registry/attributes/rpc.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | The fully-qualified logical name of the method from the RPC interface perspective. [10] | `com.example.ExampleService/exampleMethod`; `EchoService/Echo`; `_OTHER` |
