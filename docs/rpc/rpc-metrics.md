...
#### Metric: `rpc.server.time_to_first_message`
<!-- semconv metric.rpc.server.time_to_first_message -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
<!-- markdownlint-capture -->
...
| Name     | Instrument Type | Unit (UCUM) | Description    | Stability |
| -------- | --------------- | ----------- | -------------- | --------- |
| `rpc.server.time_to_first_message` | Histogram | `s` | Time to send first message for messages [1] | ![Development](https://img.shields.io/badge/-development-blue) |

**[1]:** **Streaming**: This metric is only required for server streaming RPCs
...
#### Metric: `rpc.server.time_per_message`
<!-- semconv metric.rpc.server.time_per_message -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
<!-- markdownlint-capture -->
...
| Name     | Instrument Type | Unit (UCUM) | Description    | Stability |
| -------- | --------------- | ----------- | -------------- | --------- |
| `rpc.server.time_per_message` | Histogram | `s` | Time per message after the first sent message [1] | ![Development](https://img.shields.io/badge/-development-blue) |
...
#### Metric: `rpc.client.time_to_first_message`
<!-- semconv metric.rpc.client.time_to_first_message -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
<!-- markdownlint-capture -->
...
| Name     | Instrument Type | Unit (UCUM) | Description    | Stability |
| -------- | --------------- | ----------- | -------------- | --------- |
| `rpc.client.time_to_first_message` | Histogram | `s` | Time to send first message for messages [1] | ![Development](https://img.shields.io/badge/-development-blue) |

**[1]:** **Streaming**: This metric is only required for client streaming RPCs
...
#### Metric: `rpc.client.time_per_message`
<!-- semconv metric.rpc.client.time_per_message -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
<!-- markdownlint-capture -->
...
| Name     | Instrument Type | Unit (UCUM) | Description    | Stability |
| -------- | --------------- | ----------- | -------------- | --------- |
| `rpc.client.time_per_message` | Histogram | `s` | Time per message after the first sent message [1] | ![Development](https://img.shields.io/badge/-development-blue) |
