...
See the client and server sections below for details including span events.

### Client

gRPC conventions define two types of spans: call and attempt.
...
Both gRPC and OpenTelemetry conventions define a per-call server span.
