...
| [`browser.web_vital.name`](/docs/registry/attributes/browser.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Required` | string | Name of the web vital. | `cls` [(see all values)](#browser-web-vital-name-values) |
...
| [`browser.web_vital.navigation_type`](/docs/registry/attributes/browser.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | The type of navigation, as reported by the [Navigation Timing API](https://developer.mozilla.org/docs/Web/API/PerformanceNavigationTiming/type), with additional values reported by the web-vitals library. | `navigate` [(see all values)](#browser-web-vital-navigation-type-values) |
| [`browser.web_vital.rating`](/docs/registry/attributes/browser.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | The rating of the web vital value against the "good", "needs improvement", and "poor" thresholds defined for the metric. | `good` [(see all values)](#browser-web-vital-rating-values) |
