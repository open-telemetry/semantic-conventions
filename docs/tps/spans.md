...
This document defines semantic conventions for a HTTP server spans of Transaction Processing Systems.
...
| [`tps.system.name`](/docs/registry/attributes/tps.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Required` | string | Type of Transaction Processing System | `ibm.cics`; `ibm.ims` |
