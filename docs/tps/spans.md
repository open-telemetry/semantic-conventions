...
| [`tps.system`](/docs/attributes-registry/tps.md) | string | Type of Transaction Processing System | `jta`; `oracle.tuxedo`; `ibm.cics`; `ibm.ims`; `ibm.ztpf` | `Required` | ![Experimental](https://img.shields.io/badge/-experimental-blue) |
