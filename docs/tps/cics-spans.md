...
| [`tps.system`](/docs/attributes-registry/tps.md) | string | Type of Transaction Processing System | `ibm.cics` | `Required` | ![Experimental](https://img.shields.io/badge/-experimental-blue) |
...
| [`ibm.cics.transaction.group_id`](/docs/attributes-registry/ibm.md) | string | Describes the group ID assigned at transaction attach time and can be used to correlate the transactions that CICS runs for the same incoming work request. | `TRNGROUP` | `Recommended` | ![Experimental](https://img.shields.io/badge/-experimental-blue) |
