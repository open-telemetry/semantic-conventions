...
[`EventRecord`](https://opentelemetry.io/docs/specs/otel/logs/data-model/#log-and-event-record-definition)
...
[event name](https://opentelemetry.io/docs/specs/otel/logs/data-model/#field-eventname)
...
[severity text](https://opentelemetry.io/docs/specs/otel/logs/data-model/#field-severitytext).
