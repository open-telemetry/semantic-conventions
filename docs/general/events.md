...
[`EventRecord`](https://github.com/open-telemetry/opentelemetry-specification/blob/v1.60.0/specification/logs/data-model.md#log-and-event-record-definition)
...
[event name](https://github.com/open-telemetry/opentelemetry-specification/blob/v1.60.0/specification/logs/data-model.md#field-eventname)
...
Events MUST have
[Timestamp](https://github.com/open-telemetry/opentelemetry-specification/blob/v1.60.0/specification/logs/data-model.md#field-timestamp)
set to the time when the event occurred.

Semantic conventions MUST NOT define a value for
[ObservedTimestamp](https://github.com/open-telemetry/opentelemetry-specification/blob/v1.60.0/specification/logs/data-model.md#field-observedtimestamp);
...
[severity text](https://github.com/open-telemetry/opentelemetry-specification/blob/v1.60.0/specification/logs/data-model.md#field-severitytext).
...
Semantic conventions MUST NOT define a value for
[body](https://github.com/open-telemetry/opentelemetry-specification/blob/v1.60.0/specification/logs/data-model.md#field-body)
