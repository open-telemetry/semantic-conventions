...
- [Useful Attribute Namespaces](#useful-attribute-namespaces)
...
There are some attribute which can be used to provide additional context about the log message transmissiong.
