...
| --- | --- | --- | --- | --- | --- |
| [`opentracing.ref_type`](attributes/opentracing.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | Parent-child Reference type [1] | `child_of`; `follows_from` |
