...
|---|---|---|---|---|---|
| [`profile.frame.type`](/docs/registry/attribute/profile.md) | string | Describes the interpreter or compiler of a single frame. | `cpython` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
