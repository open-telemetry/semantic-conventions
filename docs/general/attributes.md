...
- [Network communication attributes](#network-communication-attributes)
  ...
  - [Other network attributes](#other-network-attributes)
    - [Network peer attributes](#network-peer-attributes)
    ...
    - [Network local attributes](#network-local-attributes)
...
For the full list of network attributes, see the [network attribute registry](/docs/registry/attributes/network.md).
