...
| [`db.collection.namespace`](../attributes-registry/db.md) | string | Identifies MS SQL database within a server. [3] | `products`; `test.customers` | `Conditionally Required` If applicable. | ![Experimental](https://img.shields.io/badge/-experimental-blue) |
