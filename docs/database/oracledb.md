...
| [`db.query.text`](/docs/registry/attributes/db.md) | string | The database query being executed. [13] | `SELECT * FROM wuser_table where username = :mykey` | `Recommended` [14] | ![Stable](https://img.shields.io/badge/-stable-lightgreen) | Head Sampling |
