...
Semantic Conventions for [Cassandra](https://cassandra.apache.org/) client spans extend and override the [Database Semantic Conventions](../../docs/database/database-spans.md).
