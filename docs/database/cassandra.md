...
| [`db.name`](/docs/attributes-registry/db.md) | string | The keyspace name in Cassandra. [3] | `mykeyspace` | `Conditionally Required` If applicable. | ![Experimental](https://img.shields.io/badge/-experimental-blue) |
| [`db.cassandra.consistency_level`](/docs/attributes-registry/db.md) | string | The consistency level of the query. Based on consistency values from [CQL](https://docs.datastax.com/en/cassandra-oss/3.0/cassandra/dml/dmlConfigConsistency.html). | `all`; `each_quorum`; `quorum`; `local_quorum`; `one`; `two`; `three`; `local_one`; `any`; `serial`; `local_serial` | `Recommended` | ![Experimental](https://img.shields.io/badge/-experimental-blue) |
