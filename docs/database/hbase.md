...
| [`db.collection.namespace`](../attributes-registry/db.md) | string | The HBase namespace. [2] | `mynamespace` | `Conditionally Required` If applicable and is not default. | ![Experimental](https://img.shields.io/badge/-experimental-blue) |
