...
| [`user.id`](/docs/attributes-registry/user.md) | string | Unique identifier of the user. | `S-1-5-21-202424912787-2692429404-2351956786-1000` | `Conditionally Required` If available | ![Experimental](https://img.shields.io/badge/-experimental-blue) |
