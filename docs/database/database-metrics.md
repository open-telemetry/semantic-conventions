...
<!-- semconv metric.db.client.operation.count -->
...
| -------- | --------------- | ----------- | -------------- | --------- |
| `db.client.operation.count` | Counter | `{operations}` | The numbers of client operations. | ![Experimental](https://img.shields.io/badge/-experimental-blue) |
...
<!-- semconv metric.db.client.response.row_count -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
<!-- markdownlint-capture -->
