...
# Semantic Conventions for SQL Database Client Operations
...
Semantic Conventions for SQL database client span extend and override the [Database Semantic Conventions](database-spans.md).
