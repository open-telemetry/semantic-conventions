...
## Database Client Operation Span
...
Semantic Conventions for [CouchDB](https://couchdb.apache.org/) client spans extend and override the [Database Semantic Conventions](../../docs/database/database-spans.md).
