...
|---|---|---|---|---|---|
| [`db.command.name`](/docs/attributes-registry/db.md) | string | The name of the command being executed. [1] | `search`; `ml.close_job`; `cat.aliases` | `Required` | ![Release Candidate](https://img.shields.io/badge/-rc-mediumorchid) |
