...
| [`network.peer.address`](../attributes-registry/network.md) | string | Peer address of the database node operation was performed on. [7] | `10.1.2.80`; `/tmp/my.sock` | Recommended |
