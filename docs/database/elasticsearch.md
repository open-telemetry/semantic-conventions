...
| Span Name | `elasticsearch.search` |
| [`db.collection.name`](/docs/registry/attributes/db.md) | `my-index` |
| [`db.namespace`](/docs/registry/attributes/db.md) | `my-cluster` |
| [`db.operation.name`](/docs/registry/attributes/db.md) | `search` |
| [`db.query.text`](/docs/registry/attributes/db.md) | `{"query":{"term":{"user.id":"kimchy"}}}` |
| [`elasticsearch.node.name`](/docs/registry/attributes/elasticsearch.md) | `instance-0000000001` |
| [`http.request.method`](/docs/registry/attributes/http.md) | `GET` |
| [`server.address`](/docs/registry/attributes/server.md) | `elasticsearch.mydomain.com` |
| [`server.port`](/docs/registry/attributes/server.md) | `9200` |
| [`url.full`](/docs/registry/attributes/url.md) | `https://elasticsearch.mydomain.com:9200/my-index-000001/_search?from=40&size=20` |
