...
- [Span definition](#span-definition)
  ...
  - [In-memory Process](#in-memory-process)
...
instrumented protocol such as HTTP. If the db call is occurring in-memory then the [db.inmemory.internal](/docs/database/database-spans.md#in-memory-process) span should be used.
...
instrumented protocol such as HTTP, then the [db.client](/docs/database/database-spans.md#separate-process) span should be used.
