...
| [`db.statement`](../attributes-registry/db.md) | string | The database statement being executed. [3] | `SELECT * FROM wuser_table`; `SET mykey "WuValue"` | Recommended: [4] |
...
**[4]:** Should be collected by default only if there is sanitization that excludes sensitive information.
<!-- endsemconv -->
