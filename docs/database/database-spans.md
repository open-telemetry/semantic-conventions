...
# Semantic Conventions for Database Client Operations
...
- [Database Client Operation Span](#database-client-operation-span)
  - [Name](#name)
...
This span represents a database client operation.
