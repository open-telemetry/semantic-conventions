...
Semantic Conventions for [MongoDB](https://www.mongodb.com/) client spans extend and override the [Database Semantic Conventions](../../docs/database/database-spans.md).
