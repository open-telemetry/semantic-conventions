...
- [General Span Definition](#general-span-definition)
...
- [Incoming Invocations](#incoming-invocations)
  - [Incoming FaaS Span](#incoming-faas-span)
...
For example, an `http` trigger SHOULD follow the [HTTP Server semantic conventions](/docs/http/http-spans.md#http-server-semantic-conventions).
