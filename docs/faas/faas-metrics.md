...
|---|---|---|---|---|---|
| [`faas.trigger`](/docs/registry/attribute/faas.md) | string | Type of the trigger which caused this function invocation. | `datasource`; `http`; `pubsub` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
