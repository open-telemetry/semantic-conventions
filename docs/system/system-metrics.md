...
- [Linux Pressure Stall Information (PSI) Metrics](#linux-pressure-stall-information-psi-metrics)
  - [CPU pressure metrics](#cpu-pressure-metrics)
    - [Metric: `system.cpu.linux.pressure.10s`](#metric-systemcpulinuxpressure10s)
    - [Metric: `system.cpu.linux.pressure.1m`](#metric-systemcpulinuxpressure1m)
    - [Metric: `system.cpu.linux.pressure.5m`](#metric-systemcpulinuxpressure5m)
    - [Metric: `system.cpu.linux.pressure.total`](#metric-systemcpulinuxpressuretotal)
  - [Memory pressure metrics](#memory-pressure-metrics)
    - [Metric: `system.memory.linux.pressure.10s`](#metric-systemmemorylinuxpressure10s)
    - [Metric: `system.memory.linux.pressure.1m`](#metric-systemmemorylinuxpressure1m)
    - [Metric: `system.memory.linux.pressure.5m`](#metric-systemmemorylinuxpressure5m)
    - [Metric: `system.memory.linux.pressure.total`](#metric-systemmemorylinuxpressuretotal)
  - [IO pressure metrics](#io-pressure-metrics)
    - [Metric: `system.io.linux.pressure.10s`](#metric-systemiolinuxpressure10s)
    - [Metric: `system.io.linux.pressure.1m`](#metric-systemiolinuxpressure1m)
    - [Metric: `system.io.linux.pressure.5m`](#metric-systemiolinuxpressure5m)
    - [Metric: `system.io.linux.pressure.total`](#metric-systemiolinuxpressuretotal)
  - [IRQ pressure metrics](#irq-pressure-metrics)
    - [Metric: `system.irq.linux.pressure.10s`](#metric-systemirqlinuxpressure10s)
    - [Metric: `system.irq.linux.pressure.1m`](#metric-systemirqlinuxpressure1m)
    - [Metric: `system.irq.linux.pressure.5m`](#metric-systemirqlinuxpressure5m)
    - [Metric: `system.irq.linux.pressure.total`](#metric-systemirqlinuxpressuretotal)
...
## Linux Pressure Stall Information (PSI) Metrics

[Pressure Stall Information (PSI)](https://docs.kernel.org/accounting/psi.html) is a Linux kernel
feature (available since kernel 4.20) that measures the amount of time tasks are delayed due to
resource contention on CPU, memory, IO, and IRQ. PSI provides both averaged pressure over time
windows (10 seconds, 1 minute, 5 minutes) and total cumulative stall time since boot.

These metrics follow the naming pattern `system.{resource}.linux.pressure.{window}` and use the
`system.linux.pressure.stall_type` attribute to distinguish between `some` (at least some tasks stalled)
and `full` (all non-idle tasks stalled simultaneously) pressure levels.

### CPU pressure metrics

#### Metric: `system.cpu.linux.pressure.10s`

This metric is [opt-in][MetricOptIn].

<!-- semconv metric.system.cpu.linux.pressure.10s -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `system.cpu.linux.pressure.10s` | Gauge | `1` | Average system CPU pressure over the last 10 seconds. [1] | ![Development](https://img.shields.io/badge/-development-blue) | [`host`](/docs/registry/entities/host.md#host) |

**[1]:** CPU pressure from Linux [Pressure Stall Information](https://docs.kernel.org/accounting/psi.html)
indicating the share of time in which tasks were delayed due to a lack of CPU resources.
...
| Key | Stability | [Requirement Level](https://opentelemetry.io/docs/specs/semconv/general/attribute-requirement-level/) | Value Type | Description | Example Values |
| --- | --- | --- | --- | --- | --- |
| [`system.linux.pressure.stall_type`](/docs/registry/attributes/system.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | Tasks that were delayed due to lack of resources. | `some`; `full` |
...
#### Metric: `system.cpu.linux.pressure.1m`

This metric is [opt-in][MetricOptIn].

<!-- semconv metric.system.cpu.linux.pressure.1m -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `system.cpu.linux.pressure.1m` | Gauge | `1` | Average system CPU pressure over the last 1 minute. [1] | ![Development](https://img.shields.io/badge/-development-blue) | [`host`](/docs/registry/entities/host.md#host) |
...
#### Metric: `system.cpu.linux.pressure.5m`

This metric is [opt-in][MetricOptIn].

<!-- semconv metric.system.cpu.linux.pressure.5m -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `system.cpu.linux.pressure.5m` | Gauge | `1` | Average system CPU pressure over the last 5 minutes. [1] | ![Development](https://img.shields.io/badge/-development-blue) | [`host`](/docs/registry/entities/host.md#host) |
...
#### Metric: `system.cpu.linux.pressure.total`

This metric is [opt-in][MetricOptIn].

<!-- semconv metric.system.cpu.linux.pressure.total -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `system.cpu.linux.pressure.total` | Counter | `s` | Total cumulative system CPU pressure. [1] | ![Development](https://img.shields.io/badge/-development-blue) | [`host`](/docs/registry/entities/host.md#host) |

**[1]:** Total CPU pressure from Linux [Pressure Stall Information](https://docs.kernel.org/accounting/psi.html)
tracking the cumulative time in which tasks were delayed due to a lack of CPU resources.
Read from `/proc/pressure/cpu`.
...
#### Metric: `system.memory.linux.pressure.10s`

This metric is [opt-in][MetricOptIn].

<!-- semconv metric.system.memory.linux.pressure.10s -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `system.memory.linux.pressure.10s` | Gauge | `1` | Average system memory pressure over the last 10 seconds. [1] | ![Development](https://img.shields.io/badge/-development-blue) | [`host`](/docs/registry/entities/host.md#host) |

**[1]:** Memory pressure from Linux [Pressure Stall Information](https://docs.kernel.org/accounting/psi.html)
indicating the share of time in which tasks were delayed due to a lack of memory resources.
...
#### Metric: `system.memory.linux.pressure.1m`

This metric is [opt-in][MetricOptIn].

<!-- semconv metric.system.memory.linux.pressure.1m -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `system.memory.linux.pressure.1m` | Gauge | `1` | Average system memory pressure over the last 1 minute. [1] | ![Development](https://img.shields.io/badge/-development-blue) | [`host`](/docs/registry/entities/host.md#host) |
...
#### Metric: `system.memory.linux.pressure.5m`

This metric is [opt-in][MetricOptIn].

<!-- semconv metric.system.memory.linux.pressure.5m -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `system.memory.linux.pressure.5m` | Gauge | `1` | Average system memory pressure over the last 5 minutes. [1] | ![Development](https://img.shields.io/badge/-development-blue) | [`host`](/docs/registry/entities/host.md#host) |
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `system.memory.linux.pressure.total` | Counter | `s` | Total cumulative system memory pressure. [1] | ![Development](https://img.shields.io/badge/-development-blue) | [`host`](/docs/registry/entities/host.md#host) |

**[1]:** Total memory pressure from Linux [Pressure Stall Information](https://docs.kernel.org/accounting/psi.html)
tracking the cumulative time in which tasks were delayed due to a lack of memory resources.
Read from `/proc/pressure/memory`.
...
#### Metric: `system.io.linux.pressure.10s`

This metric is [opt-in][MetricOptIn].

<!-- semconv metric.system.io.linux.pressure.10s -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `system.io.linux.pressure.10s` | Gauge | `1` | Average system IO pressure over the last 10 seconds. [1] | ![Development](https://img.shields.io/badge/-development-blue) | [`host`](/docs/registry/entities/host.md#host) |

**[1]:** IO pressure from Linux [Pressure Stall Information](https://docs.kernel.org/accounting/psi.html)
indicating the share of time in which tasks were delayed due to a lack of IO resources.
...
#### Metric: `system.io.linux.pressure.1m`

This metric is [opt-in][MetricOptIn].

<!-- semconv metric.system.io.linux.pressure.1m -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `system.io.linux.pressure.1m` | Gauge | `1` | Average system IO pressure over the last 1 minute. [1] | ![Development](https://img.shields.io/badge/-development-blue) | [`host`](/docs/registry/entities/host.md#host) |
...
#### Metric: `system.io.linux.pressure.5m`

This metric is [opt-in][MetricOptIn].

<!-- semconv metric.system.io.linux.pressure.5m -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `system.io.linux.pressure.5m` | Gauge | `1` | Average system IO pressure over the last 5 minutes. [1] | ![Development](https://img.shields.io/badge/-development-blue) | [`host`](/docs/registry/entities/host.md#host) |
...
#### Metric: `system.io.linux.pressure.total`

This metric is [opt-in][MetricOptIn].

<!-- semconv metric.system.io.linux.pressure.total -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `system.io.linux.pressure.total` | Counter | `s` | Total cumulative system IO pressure. [1] | ![Development](https://img.shields.io/badge/-development-blue) | [`host`](/docs/registry/entities/host.md#host) |

**[1]:** Total IO pressure from Linux [Pressure Stall Information](https://docs.kernel.org/accounting/psi.html)
tracking the cumulative time in which tasks were delayed due to a lack of IO resources.
Read from `/proc/pressure/io`.
...
#### Metric: `system.irq.linux.pressure.10s`

This metric is [opt-in][MetricOptIn].

<!-- semconv metric.system.irq.linux.pressure.10s -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `system.irq.linux.pressure.10s` | Gauge | `1` | Average system IRQ pressure over the last 10 seconds. [1] | ![Development](https://img.shields.io/badge/-development-blue) | [`host`](/docs/registry/entities/host.md#host) |

**[1]:** IRQ pressure from Linux [Pressure Stall Information](https://docs.kernel.org/accounting/psi.html)
indicating the share of time in which tasks were delayed due to a lack of IRQ resources.
Read from `/proc/pressure/irq`.
...
#### Metric: `system.irq.linux.pressure.1m`

This metric is [opt-in][MetricOptIn].

<!-- semconv metric.system.irq.linux.pressure.1m -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `system.irq.linux.pressure.1m` | Gauge | `1` | Average system IRQ pressure over the last 1 minute. [1] | ![Development](https://img.shields.io/badge/-development-blue) | [`host`](/docs/registry/entities/host.md#host) |
...
#### Metric: `system.irq.linux.pressure.5m`

This metric is [opt-in][MetricOptIn].

<!-- semconv metric.system.irq.linux.pressure.5m -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `system.irq.linux.pressure.5m` | Gauge | `1` | Average system IRQ pressure over the last 5 minutes. [1] | ![Development](https://img.shields.io/badge/-development-blue) | [`host`](/docs/registry/entities/host.md#host) |
...
#### Metric: `system.irq.linux.pressure.total`

This metric is [opt-in][MetricOptIn].

<!-- semconv metric.system.irq.linux.pressure.total -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `system.irq.linux.pressure.total` | Counter | `s` | Total cumulative system IRQ pressure. [1] | ![Development](https://img.shields.io/badge/-development-blue) | [`host`](/docs/registry/entities/host.md#host) |

**[1]:** Total IRQ pressure from Linux [Pressure Stall Information](https://docs.kernel.org/accounting/psi.html)
tracking the cumulative time in which tasks were delayed due to a lack of IRQ resources.
Read from `/proc/pressure/irq`.
