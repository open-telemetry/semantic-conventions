...
- [`system.{os}.` - OS Specific System Metrics](#systemos---os-specific-system-metrics)
  ...
  - [Metric: `system.linux.memory.slab`](#metric-systemlinuxmemoryslab)
...
### Metric: `system.linux.memory.slab`

<!-- semconv metric.system.linux.memory.slab(metric_table) -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
<!-- markdownlint-capture -->
...
| Name     | Instrument Type | Unit (UCUM) | Description    | Stability |
| -------- | --------------- | ----------- | -------------- | --------- |
| `system.linux.memory.slab` | UpDownCounter | `By` | Memory used by the Linux kernel for managing caches of frequently used objects | ![Experimental](https://img.shields.io/badge/-experimental-blue) |
