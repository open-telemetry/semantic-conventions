...
- [Network metrics](#network-metrics)
  ...
  - [Metric: `system.network.bandwidth.utilization`](#metric-systemnetworkbandwidthutilization)
...
### Metric: `system.network.bandwidth.utilization`

This metric is [opt-in][MetricOptIn].

<!-- semconv metric.system.network.bandwidth.utilization -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `system.network.bandwidth.utilization` | Gauge | `1` | Network bandwidth utilization as a fraction. [1] | ![Development](https://img.shields.io/badge/-development-blue) | [`host`](/docs/registry/entities/host.md#host) |

**[1]:** This metric SHOULD be calculated as the rate of transmitted and received bytes over the measurement interval, converted to bits per second, divided by the available network interface capacity in bits per second.
For full-duplex interfaces, the available capacity SHOULD be the combined receive and transmit capacity.
For half-duplex interfaces, the available capacity SHOULD be the single shared interface capacity.
Instrumentations SHOULD NOT emit this metric when the available capacity is unknown.
