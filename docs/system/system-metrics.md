...
- [Network metrics](#network-metrics)
  ...
  - [Metric: `system.network.bandwidth.limit`](#metric-systemnetworkbandwidthlimit)
...
### Metric: `system.network.bandwidth.limit`

This metric is [opt-in][MetricOptIn].

<!-- semconv metric.system.network.bandwidth.limit -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `system.network.bandwidth.limit` | UpDownCounter | `By/s` | The bandwidth limit of the network interface, derived from the reported link speed. [1] | ![Development](https://img.shields.io/badge/-development-blue) | [`host`](/docs/registry/entities/host.md#host) |
