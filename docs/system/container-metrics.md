...
| Name     | Instrument Type | Unit (UCUM) | Description    | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `container.filesystem.available` | Gauge | `By` | Container filesystem available [1] | ![Development](https://img.shields.io/badge/-development-blue) | `container` |
...
| Name     | Instrument Type | Unit (UCUM) | Description    | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `container.filesystem.capacity` | Gauge | `By` | Container filesystem capacity [1] | ![Development](https://img.shields.io/badge/-development-blue) | `container` |
...
| Name     | Instrument Type | Unit (UCUM) | Description    | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `container.filesystem.usage` | Gauge | `By` | Container filesystem usage [1] | ![Development](https://img.shields.io/badge/-development-blue) | `container` |
