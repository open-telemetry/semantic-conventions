...
|---|---|---|---|---|---|
| [`cpu.logical_number`](/docs/registry/attribute/cpu.md) | int | The logical CPU number [0..n-1] | `1` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
| [`cpu.mode`](/docs/registry/attribute/cpu.md) | string | The mode of the CPU [1] | `user`; `system` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
