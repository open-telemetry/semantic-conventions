...
- [Pod metrics](#pod-metrics)
  ...
  - [Metric: `k8s.pod.cpu.limit`](#metric-k8spodcpulimit)
  - [Metric: `k8s.pod.cpu.request`](#metric-k8spodcpurequest)
  - [Metric: `k8s.pod.cpu.limit_utilization`](#metric-k8spodcpulimit_utilization)
  - [Metric: `k8s.pod.cpu.request_utilization`](#metric-k8spodcpurequest_utilization)
  - [Metric: `k8s.pod.cpu.node_utilization`](#metric-k8spodcpunode_utilization)
...
- [Node metrics](#node-metrics)
  ...
  - [Metric: `k8s.node.cpu.utilization`](#metric-k8snodecpuutilization)
...
- [K8s Container metrics](#k8s-container-metrics)
  - [Metric: `k8s.container.cpu.usage`](#metric-k8scontainercpuusage)
  ...
  - [Metric: `k8s.container.cpu.node_utilization`](#metric-k8scontainercpunode_utilization)
...
### Metric: `k8s.pod.cpu.limit`

This metric is [recommended][MetricRecommended].

<!-- semconv metric.k8s.pod.cpu.limit -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `k8s.pod.cpu.limit` | UpDownCounter | `{cpu}` | Maximum CPU resource limit set for the pod. [1] | ![Development](https://img.shields.io/badge/-development-blue) | [`k8s.pod`](/docs/registry/entities/k8s.md#k8s-pod) |

**[1]:** Pod-level CPU limits are supported from Kubernetes 1.34+ via the PodSpec resources field.
When not specified at the pod level, the value may be derived from the sum of container limits.
See resources in [PodSpec](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.34/#podspec-v1-core) for details.

<!-- prettier-ignore-end -->
<!-- END AUTOGENERATED TEXT -->
<!-- endsemconv -->

### Metric: `k8s.pod.cpu.request`

This metric is [recommended][MetricRecommended].

<!-- semconv metric.k8s.pod.cpu.request -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `k8s.pod.cpu.request` | UpDownCounter | `{cpu}` | CPU resource requested for the pod. [1] | ![Development](https://img.shields.io/badge/-development-blue) | [`k8s.pod`](/docs/registry/entities/k8s.md#k8s-pod) |

**[1]:** Pod-level CPU requests are supported from Kubernetes 1.34+ via the PodSpec resources field.
When not specified at the pod level, the value may be derived from the sum of container requests.
See resources in [PodSpec](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.34/#podspec-v1-core) for details.
...
### Metric: `k8s.pod.cpu.limit_utilization`

This metric is [opt-in][MetricOptIn].

<!-- semconv metric.k8s.pod.cpu.limit_utilization -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `k8s.pod.cpu.limit_utilization` | Gauge | `1` | The ratio of pod CPU usage to its CPU limit. [1] | ![Development](https://img.shields.io/badge/-development-blue) | [`k8s.pod`](/docs/registry/entities/k8s.md#k8s-pod) |

**[1]:** The value range is [0.0, 1.0]. A value of 1.0 means the pod is using 100% of its CPU limit. If the CPU limit is not set for the pod, or if one of the pod's containers has no CPU limit, this metric SHOULD NOT be emitted.

<!-- prettier-ignore-end -->
<!-- END AUTOGENERATED TEXT -->
<!-- endsemconv -->

### Metric: `k8s.pod.cpu.request_utilization`

This metric is [opt-in][MetricOptIn].

<!-- semconv metric.k8s.pod.cpu.request_utilization -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `k8s.pod.cpu.request_utilization` | Gauge | `1` | The ratio of pod CPU usage to its CPU request. [1] | ![Development](https://img.shields.io/badge/-development-blue) | [`k8s.pod`](/docs/registry/entities/k8s.md#k8s-pod) |

**[1]:** The value is typically in the range [0.0, 1.0]. A value of 1.0 means the pod is using 100% of its CPU request. Values may exceed 1.0 when usage exceeds the request. If the CPU request is not set for the pod, or if one of the pod's containers has no CPU request, this metric SHOULD NOT be emitted.

<!-- prettier-ignore-end -->
<!-- END AUTOGENERATED TEXT -->
<!-- endsemconv -->

### Metric: `k8s.pod.cpu.node_utilization`

This metric is [opt-in][MetricOptIn].

<!-- semconv metric.k8s.pod.cpu.node_utilization -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `k8s.pod.cpu.node_utilization` | Gauge | `1` | The ratio of pod CPU usage to the node's allocatable CPU. [1] | ![Development](https://img.shields.io/badge/-development-blue) | [`k8s.pod`](/docs/registry/entities/k8s.md#k8s-pod) |

**[1]:** The value is typically in the range [0.0, 1.0]. A value of 1.0 means the pod is using 100% of the node's allocatable CPU resources.
...
<!-- semconv metric.k8s.node.cpu.utilization -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `k8s.node.cpu.utilization` | Gauge | `1` | The ratio of node CPU usage over its allocatable CPU. [1] | ![Development](https://img.shields.io/badge/-development-blue) | [`k8s.node`](/docs/registry/entities/k8s.md#k8s-node) |

**[1]:** The value range is [0.0, 1.0]. A value of 1.0 means the node is using 100% of its allocatable CPU resources.
...
### Metric: `k8s.container.cpu.usage`

This metric is [recommended][MetricRecommended].

<!-- semconv metric.k8s.container.cpu.usage -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `k8s.container.cpu.usage` | Gauge | `{cpu}` | Total CPU time consumed by the container averaged over the sample window. [1] | ![Development](https://img.shields.io/badge/-development-blue) | [`k8s.container`](/docs/registry/entities/k8s.md#k8s-container) |

**[1]:** For more details see UsageNanoCores [CPU Stats](https://pkg.go.dev/k8s.io/kubelet@v0.35.2/pkg/apis/stats/v1alpha1#CPUStats).
...
### Metric: `k8s.container.cpu.node_utilization`

This metric is [opt-in][MetricOptIn].

<!-- semconv metric.k8s.container.cpu.node_utilization -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `k8s.container.cpu.node_utilization` | Gauge | `1` | The ratio of container CPU usage to the node's allocatable CPU. [1] | ![Development](https://img.shields.io/badge/-development-blue) | [`k8s.container`](/docs/registry/entities/k8s.md#k8s-container) |

**[1]:** The value is typically in the range [0.0, 1.0]. A value of 1.0 means the container is using 100% of the node's allocatable CPU resources.
