...
>>>>>>> f6029e09 (rename to k8s.container.restart.count)
...
=======
| `k8s.container.restart.count` | UpDownCounter | `{restart}` | Describes how many times the container has restarted in the recent past. [1] | ![Development](https://img.shields.io/badge/-development-blue) |  |
>>>>>>> f6029e09 (rename to k8s.container.restart.count)
