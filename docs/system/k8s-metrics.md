...
- [Resource Quota metrics](#resource-quota-metrics)
  ...
  - [Metric: `k8s.resourcequota.hugepages.request.hard`](#metric-k8sresourcequotahugepagesrequesthard)
  - [Metric: `k8s.resourcequota.hugepages.request.used`](#metric-k8sresourcequotahugepagesrequestused)
  ...
  - [Metric: `k8s.resourcequota.persistentvolumeclaims.hard`](#metric-k8sresourcequotapersistentvolumeclaimshard)
  - [Metric: `k8s.resourcequota.persistentvolumeclaims.used`](#metric-k8sresourcequotapersistentvolumeclaimsused)
...
### Metric: `k8s.resourcequota.hugepages.request.hard`

This metric is [recommended][MetricRecommended].

<!-- semconv metric.k8s.resourcequota.hugepages.request.hard -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
<!-- markdownlint-capture -->
...
### Metric: `k8s.resourcequota.hugepages.request.used`

This metric is [recommended][MetricRecommended].

<!-- semconv metric.k8s.resourcequota.hugepages.request.used -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
<!-- markdownlint-capture -->
...
| Attribute  | Type | Description  | Examples  | [Requirement Level](https://opentelemetry.io/docs/specs/semconv/general/attribute-requirement-level/) | Stability |
|---|---|---|---|---|---|
| [`k8s.storage.class_name`](/docs/registry/attributes/k8s.md) | string | The storage class of the K8s storage. | `gold.storageclass.storage.k8s.io` | `Conditionally Required` [1] | ![Development](https://img.shields.io/badge/-development-blue) |

**[1] `k8s.storage.class_name`:** The `k8s.storage.class_name` should be required when a resource quota is defined for a specific
storage class.
...
### Metric: `k8s.resourcequota.persistentvolumeclaims.hard`

This metric is [recommended][MetricRecommended].

<!-- semconv metric.k8s.resourcequota.persistentvolumeclaims.hard -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
<!-- markdownlint-capture -->
...
| Name     | Instrument Type | Unit (UCUM) | Description    | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `k8s.resourcequota.persistentvolumeclaims.hard` | UpDownCounter | `{persistentvolumeclaim}` | The total number of PersistentVolumeClaims that can exist in the namespace.
...
### Metric: `k8s.resourcequota.persistentvolumeclaims.used`

This metric is [recommended][MetricRecommended].

<!-- semconv metric.k8s.resourcequota.persistentvolumeclaims.used -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
<!-- markdownlint-capture -->
...
| Name     | Instrument Type | Unit (UCUM) | Description    | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `k8s.resourcequota.persistentvolumeclaims.used` | UpDownCounter | `{persistentvolumeclaim}` | The total number of PersistentVolumeClaims that can exist in the namespace.
