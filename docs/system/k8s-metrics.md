...
- [K8s Container metrics](#k8s-container-metrics)
  ...
  - [Metric: `k8s.node.condition`](#metric-k8snodecondition)
...
<!-- semconv metric.k8s.node.condition -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
<!-- markdownlint-capture -->
...
| Name     | Instrument Type | Unit (UCUM) | Description    | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `k8s.node.condition` | UpDownCounter | `{node}` | Describes the condition of a particular Node. | ![Development](https://img.shields.io/badge/-development-blue) | `k8s.node` |
