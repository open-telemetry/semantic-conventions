...
- [K8s Container metrics](#k8s-container-metrics)
  - [Metric: `k8s.container.restarts`](#metric-k8scontainerrestarts)
...
<!-- semconv metric.k8s.container.restarts -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
<!-- markdownlint-capture -->
...
| Name     | Instrument Type | Unit (UCUM) | Description    | Stability |
| -------- | --------------- | ----------- | -------------- | --------- |
| `k8s.container.restarts` | UpDownCounter | `{restart}` | Describes how many times the container has restarted in the recent past. [1] | ![Development](https://img.shields.io/badge/-development-blue) |
