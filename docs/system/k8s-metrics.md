...
- [Resource Quota metrics](#resource-quota-metrics)
  - [Metric: `k8s.resourcequota.cpu.limit`](#metric-k8sresourcequotacpulimit)
  ...
  - [Metric: `k8s.resourcequota.ephemeral_storage.request`](#metric-k8sresourcequotaephemeral_storagerequest)
  - [Metric: `k8s.resourcequota.ephemeral_storage.limit`](#metric-k8sresourcequotaephemeral_storagelimit)
...
### Metric: `k8s.resourcequota.cpu.limit`

This metric is [recommended][MetricRecommended].

<!-- semconv metric.k8s.resourcequota.cpu.limit -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
<!-- markdownlint-capture -->
...
### Metric: `k8s.resourcequota.cpu.request`

This metric is [recommended][MetricRecommended].

<!-- semconv metric.k8s.resourcequota.cpu.request -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
<!-- markdownlint-capture -->
...
### Metric: `k8s.resourcequota.memory.limit`

This metric is [recommended][MetricRecommended].

<!-- semconv metric.k8s.resourcequota.memory.limit -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
<!-- markdownlint-capture -->
...
### Metric: `k8s.resourcequota.memory.request`

This metric is [recommended][MetricRecommended].

<!-- semconv metric.k8s.resourcequota.memory.request -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
<!-- markdownlint-capture -->
...
### Metric: `k8s.resourcequota.ephemeral_storage.request`

This metric is [recommended][MetricRecommended].

<!-- semconv metric.k8s.resourcequota.ephemeral_storage.request -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
<!-- markdownlint-capture -->
...
| Name     | Instrument Type | Unit (UCUM) | Description    | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `k8s.resourcequota.ephemeral_storage.request` | Gauge | `By` | Across all pods in the namespace, the sum of local ephemeral storage requests cannot exceed this value. [1] | ![Development](https://img.shields.io/badge/-development-blue) |  |
...
### Metric: `k8s.resourcequota.ephemeral_storage.limit`

This metric is [recommended][MetricRecommended].

<!-- semconv metric.k8s.resourcequota.ephemeral_storage.limit -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
<!-- markdownlint-capture -->
...
| Name     | Instrument Type | Unit (UCUM) | Description    | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `k8s.resourcequota.ephemeral_storage.limit` | Gauge | `By` | Across all pods in the namespace, the sum of local ephemeral storage limits cannot exceed this value. [1] | ![Development](https://img.shields.io/badge/-development-blue) |  |
...
### Metric: `k8s.resourcequota.object_count`

This metric is [recommended][MetricRecommended].

<!-- semconv metric.k8s.resourcequota.object_count -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
<!-- markdownlint-capture -->
