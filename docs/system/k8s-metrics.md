...
| Name     | Instrument Type | Unit (UCUM) | Description    | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `k8s.pod.volume.available` | Gauge | `By` | Pod volume available [1] | ![Development](https://img.shields.io/badge/-development-blue) | `k8s.pod` |
...
| [`k8s.volume.type`](/docs/registry/attributes/k8s.md) | string | The type of the K8s volume. | `emptyDir`; `persistentVolumeClaim` | `Opt-In` | ![Development](https://img.shields.io/badge/-development-blue) |
...
| Name     | Instrument Type | Unit (UCUM) | Description    | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `k8s.pod.volume.capacity` | Gauge | `By` | Pod volume capacity [1] | ![Development](https://img.shields.io/badge/-development-blue) | `k8s.pod` |
...
| Name     | Instrument Type | Unit (UCUM) | Description    | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `k8s.pod.volume.usage` | Gauge | `By` | Pod volume usage [1] | ![Development](https://img.shields.io/badge/-development-blue) | `k8s.pod` |
