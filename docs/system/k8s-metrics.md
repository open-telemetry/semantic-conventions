...
[PodStatus](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.35/#podstatus-v1-core).
The value range is [0.0,1.0]. A value of 1.0 means the Pod is using 100% of its actual CPU request.
If the CPU request is not set, this metric SHOULD NOT be emitted for that Pod.
