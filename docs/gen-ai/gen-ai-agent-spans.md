...
- [Spans](#spans)
  ...
  - [Invoke agent server span](#invoke-agent-server-span)
...
<!-- semconv span.gen_ai.invoke_agent.server -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| [`client.address`](/docs/registry/attributes/client.md) | ![Stable](https://img.shields.io/badge/-stable-lightgreen) | `Opt-In` | string | Client address - domain name if available without reverse DNS lookup; otherwise, IP address or Unix domain socket name. [14] | `client.example.com`; `10.1.2.80`; `/tmp/my.sock` |
| [`client.port`](/docs/registry/attributes/client.md) | ![Stable](https://img.shields.io/badge/-stable-lightgreen) | `Opt-In` | int | Client port number. [15] | `65123` |
...
**[9] `gen_ai.usage.cache_creation.input_tokens`:** When the agent performs multiple GenAI requests internally, this value SHOULD be the sum of all cache creation input tokens across those requests.

**[10] `gen_ai.usage.cache_read.input_tokens`:** When the agent performs multiple GenAI requests internally, this value SHOULD be the sum of all cache read input tokens across those requests.

**[11] `gen_ai.usage.input_tokens`:** When the agent performs multiple GenAI requests internally, this value SHOULD be the sum of all input tokens used across those requests.

**[12] `gen_ai.usage.output_tokens`:** When the agent performs multiple GenAI requests internally, this value SHOULD be the sum of all output tokens used across those requests.
