...
| [`gen_ai.agent.invocation.trigger`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` if known | string | Indicates what triggered the agent invocation. | `direct`; `agent` |
