...
**[10] `gen_ai.usage.cache_creation.input_tokens`:** When the agent performs multiple GenAI requests internally, this value SHOULD be the sum of all cache creation input tokens across those requests.

**[11] `gen_ai.usage.cache_read.input_tokens`:** When the agent performs multiple GenAI requests internally, this value SHOULD be the sum of all cache read input tokens across those requests.

**[12] `gen_ai.usage.input_tokens`:** When the agent performs multiple GenAI requests internally, this value SHOULD be the sum of all input tokens used across those requests.

**[13] `gen_ai.usage.output_tokens`:** When the agent performs multiple GenAI requests internally, this value SHOULD be the sum of all output tokens used across those requests.
