...
| [`server.address`](/docs/registry/attributes/server.md) | ![Stable](https://img.shields.io/badge/-stable-lightgreen) | `Recommended` when span kind is `CLIENT`. | string | GenAI server address. [13] | `example.com`; `10.1.2.80`; `/tmp/my.sock` |
...
| [`gen_ai.usage.cache_creation_input_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | int | The number of input tokens written to a provider-managed cache. [18] | `25` |
...
**[18] `gen_ai.usage.cache_creation_input_tokens`:** Subset of `gen_ai.usage.input_tokens`.
