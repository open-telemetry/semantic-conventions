...
| [`gen_ai.agent.role`](/docs/registry/attributes/gen-ai.md) | string | The role of the GenAI agent within the application. Different roles may have different capabilities and responsibilities. It is different from the agent's name and description because it indicates the purpose of the agent. | `Assistant`; `Researcher` | `Conditionally Required` If provided by the application. | ![Development](https://img.shields.io/badge/-development-blue) |
