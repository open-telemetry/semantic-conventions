...
| [`gen_ai.system`](/docs/attributes-registry/gen-ai.md) | string | The name of the Generative AI vendor as recognized from the client side. [2] | `openai` | `Required` | ![Experimental](https://img.shields.io/badge/-experimental-blue) |
