...
These attributes track input data and metadata for a request to an WatsonX AI model. The attributes include general Generative AI and ones specific the WatsonX AI.

<!-- semconv span.gen_ai.watsonx.client -->
...
Describes an WatsonX AI operation span.
...
| [`gen_ai.watsonxai.request.decoding_method`](/docs/registry/attributes/gen-ai.md) | string | The decoding format that is requested. | `sample`; `greedy` | `Conditionally Required` if the request includes a decoding_format | ![Development](https://img.shields.io/badge/-development-blue) |
| [`gen_ai.watsonxai.request.max_token`](/docs/registry/attributes/gen-ai.md) | int | Controls the maximum number of tokens in the generated output. | `200` | `Conditionally Required` if the request includes max_token | ![Development](https://img.shields.io/badge/-development-blue) |
| [`gen_ai.watsonxai.request.min_token`](/docs/registry/attributes/gen-ai.md) | int | Controls the minimum number of tokens in the generated output. | `50` | `Conditionally Required` if the request includes min_token | ![Development](https://img.shields.io/badge/-development-blue) |
| [`gen_ai.watsonxai.request.repetition_penalty`](/docs/registry/attributes/gen-ai.md) | double | The higher the penalty, the less likely it is that the result will include repeated text. | `2.0` | `Conditionally Required` if the request includes repetition_penalty | ![Development](https://img.shields.io/badge/-development-blue) |
...
| [`gen_ai.usage.input_tokens`](/docs/registry/attributes/gen-ai.md) | int | The number of tokens used in the prompt sent to WatsonX AI. | `100` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
| [`gen_ai.usage.output_tokens`](/docs/registry/attributes/gen-ai.md) | int | The number of tokens used in the completions from WatsonX AI. | `180` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
