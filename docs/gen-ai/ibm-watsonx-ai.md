...
<!-- semconv span.ibm.watsonx.ai.inference.client -->
...
| [`ibm.watsonx.ai.request.project_id`](/docs/registry/attributes/ibm.md) | string | The project ID in IBM WatsonX AI. | `12345678-abcd-1234-efgh-1234567890ab` | `Conditionally Required` if the request includes a project_id | ![Development](https://img.shields.io/badge/-development-blue) |
| [`ibm.watsonx.ai.request.space_id`](/docs/registry/attributes/ibm.md) | string | The space ID in IBM WatsonX AI. | `abcdef12-3456-7890-abcd-ef1234567890` | `Conditionally Required` if the request includes a space_id | ![Development](https://img.shields.io/badge/-development-blue) |
| [`ibm.watsonx.ai.response.trace_id`](/docs/registry/attributes/ibm.md) | string | The trace ID returned by IBM WatsonX AI. | `wxt-12345678-abcd-1234-efgh-1234567890ab` | `Conditionally Required` [7] | ![Development](https://img.shields.io/badge/-development-blue) |
