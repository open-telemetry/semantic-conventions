...
| [`gen_ai.data_source.id`](/docs/attributes-registry/gen-ai.md) | string | The data source identifier. | `H7STPQYOND` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
