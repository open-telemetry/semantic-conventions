...
The Semantic Conventions for [AWS Bedrock](https://aws.amazon.com/bedrock/) and [AWS Bedrock AgentCore](https://aws.amazon.com/bedrock/agentcore/) extend and override the semantic conventions
...
## AWS Bedrock AgentCore Spans

The Semantic Conventions for [AWS Bedrock AgentCore](https://aws.amazon.com/bedrock/agentcore/) extend the semantic conventions
for [GenAI Agent Spans](gen-ai-agent-spans.md).

`gen_ai.provider.name` MUST be set to `"aws.bedrock"`.

These attributes track input data and metadata for agent invocations using AWS Bedrock AgentCore.

<!-- semconv span.aws.bedrock.agentcore.client -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
<!-- markdownlint-capture -->
...
Describes an AWS Bedrock AgentCore operation span.
...
| Attribute  | Type | Description  | Examples  | [Requirement Level](https://opentelemetry.io/docs/specs/semconv/general/attribute-requirement-level/) | Stability |
|---|---|---|---|---|---|
| [`aws.bedrock.agentcore.browser.arn`](/docs/registry/attributes/aws.md) | string | The Amazon Resource Name (ARN) of the browser. | `arn:aws:bedrock-agentcore:us-east-1:123456789012:browser/myBrowser-a1b2c3d4e5` | `Conditionally Required` when available | ![Development](https://img.shields.io/badge/-development-blue) |
| [`aws.bedrock.agentcore.code_interpreter.arn`](/docs/registry/attributes/aws.md) | string | The Amazon Resource Name (ARN) of the code interpreter. | `arn:aws:bedrock-agentcore:us-east-1:123456789012:code-interpreter/myInterpreter-a1b2c3d4e5` | `Conditionally Required` when available | ![Development](https://img.shields.io/badge/-development-blue) |
| [`aws.bedrock.agentcore.gateway.arn`](/docs/registry/attributes/aws.md) | string | The Amazon Resource Name (ARN) of the gateway. | `arn:aws:bedrock-agentcore:us-east-1:123456789012:gateway/mygateway-a1b2c3d4e5` | `Conditionally Required` when available | ![Development](https://img.shields.io/badge/-development-blue) |
| [`aws.bedrock.agentcore.identity.workload_identity.arn`](/docs/registry/attributes/aws.md) | string | The Amazon Resource Name (ARN) of the workload identity. | `arn:aws:bedrock-agentcore:us-east-1:123456789012:workload-identity/my-workload-identity` | `Conditionally Required` when available | ![Development](https://img.shields.io/badge/-development-blue) |
| [`aws.bedrock.agentcore.memory.arn`](/docs/registry/attributes/aws.md) | string | The Amazon Resource Name (ARN) of the memory. | `arn:aws:bedrock-agentcore:us-east-1:123456789012:memory/myMemory-a1b2c3d4e5` | `Conditionally Required` when available | ![Development](https://img.shields.io/badge/-development-blue) |
| [`aws.bedrock.agentcore.runtime.arn`](/docs/registry/attributes/aws.md) | string | The Amazon Resource Name (ARN) of the runtime. | `arn:aws:bedrock-agentcore:us-east-1:123456789012:runtime/myRuntime-a1b2c3d4e5` | `Conditionally Required` when available | ![Development](https://img.shields.io/badge/-development-blue) |
| [`aws.bedrock.agentcore.runtime_endpoint.arn`](/docs/registry/attributes/aws.md) | string | The Amazon Resource Name (ARN) of the AgentCore Runtime endpoint. | `arn:aws:bedrock-agentcore:us-east-1:123456789012:agentEndpoint/a1b2c3d4-e5f6-7890-abcd-ef1234567890` | `Conditionally Required` when available | ![Development](https://img.shields.io/badge/-development-blue) |
...
| [`gen_ai.browser.id`](/docs/registry/attributes/gen-ai.md) | string | The unique identifier of the browser session. | `myBrowser-a1b2c3d4e5` | `Conditionally Required` if applicable. | ![Development](https://img.shields.io/badge/-development-blue) |
| [`gen_ai.code_interpreter.id`](/docs/registry/attributes/gen-ai.md) | string | The unique identifier of the code interpreter session. | `myInterpreter-a1b2c3d4e5` | `Conditionally Required` if applicable. | ![Development](https://img.shields.io/badge/-development-blue) |
| [`gen_ai.gateway.id`](/docs/registry/attributes/gen-ai.md) | string | The unique identifier of the gateway session. | `mygateway-a1b2c3d4e5` | `Conditionally Required` if applicable. | ![Development](https://img.shields.io/badge/-development-blue) |
| [`gen_ai.memory.id`](/docs/registry/attributes/gen-ai.md) | string | The unique identifier of the memory session. | `myMemory-a1b2c3d4e5` | `Conditionally Required` if applicable. | ![Development](https://img.shields.io/badge/-development-blue) |
| [`gen_ai.operation.name`](/docs/registry/attributes/gen-ai.md) | string | The name of the operation being performed. [2] | `chat`; `generate_content`; `text_completion` | `Conditionally Required` if available | ![Development](https://img.shields.io/badge/-development-blue) |
| [`gen_ai.provider.name`](/docs/registry/attributes/gen-ai.md) | string | The Generative AI provider as identified by the client or server instrumentation. [3] | `openai`; `gcp.gen_ai`; `gcp.vertex_ai` | `Conditionally Required` if available | ![Development](https://img.shields.io/badge/-development-blue) |
...
| [`gen_ai.runtime.id`](/docs/registry/attributes/gen-ai.md) | string | The unique identifier of the runtime session. | `myRuntime-a1b2c3d4e5` | `Conditionally Required` if applicable. | ![Development](https://img.shields.io/badge/-development-blue) |
