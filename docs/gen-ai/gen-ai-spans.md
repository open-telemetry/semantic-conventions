...
| [`gen_ai.model.version`](/docs/registry/attributes/gen-ai.md) | string | The version identifier of the GenAI model being used for the request. [3] | `gpt-4-0613`; `claude-2.1`; `claude-3-sonnet`; `Mistral-7B-v0.1` | `Conditionally Required` If available | ![Development](https://img.shields.io/badge/-development-blue) |
...
| [`gen_ai.request.encoding_formats`](/docs/registry/attributes/gen-ai.md) | string[] | The encoding formats requested in an embeddings operation, if specified. [6] | `["base64"]`; `["float", "binary"]` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
| [`gen_ai.usage.input_tokens`](/docs/registry/attributes/gen-ai.md) | int | The number of tokens used in the GenAI input (prompt). | `100` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
...
**[3] `gen_ai.model.version`:** The version identifier of the GenAI model used for this request. Common examples include version suffixes or release names from  model providers. For instance: - OpenAI: "gpt-4-0613" indicates the GPT-4 version released on June 13, 2023. - Claude: "claude-2.1", "claude-3-sonnet" represent major iterations. - Mistral: "Mistral-7B-v0.1" denotes a specific checkpoint of the model. This helps differentiate behavior across updates, especially for long-running or version-sensitive applications.
...
| [`gen_ai.tool.version`](/docs/registry/attributes/gen-ai.md) | string | Version of the tool utilized by the agent. [5] | `0.1.2` | `Recommended` if available | ![Development](https://img.shields.io/badge/-development-blue) |
...
**[5] `gen_ai.tool.version`:** include version if tool schema exposes it.
