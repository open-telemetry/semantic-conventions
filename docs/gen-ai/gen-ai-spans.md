...
| [`gen_ai.usage.cache_read_input_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | int | The number of input tokens served from a provider-managed cache. [10] | `50` |
...
| [`gen_ai.usage.cache_creation_input_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | int | The number of input tokens written to a provider-managed cache. [17] | `25` |
...
**[10] `gen_ai.usage.cache_read_input_tokens`:** Subset of `gen_ai.usage.input_tokens`.

**[11] `gen_ai.usage.input_tokens`:** When normalizing provider responses:
...
**[17] `gen_ai.usage.cache_creation_input_tokens`:** Subset of `gen_ai.usage.input_tokens`.
...
| [`gen_ai.usage.cache_read_input_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | int | The number of input tokens served from a provider-managed cache. [6] | `50` |
...
| [`gen_ai.usage.cache_creation_input_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | int | The number of input tokens written to a provider-managed cache. [9] | `25` |
...
**[6] `gen_ai.usage.cache_read_input_tokens`:** Subset of `gen_ai.usage.input_tokens`.

**[7] `gen_ai.usage.input_tokens`:** This value MUST include cached tokens (cache reads and cache writes) when the provider exposes them.
...
**[9] `gen_ai.usage.cache_creation_input_tokens`:** Subset of `gen_ai.usage.input_tokens`.
