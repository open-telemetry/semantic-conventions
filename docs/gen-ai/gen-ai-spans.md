...
| [`gen_ai.usage.cache_read_input_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | int | The number of input tokens served from a provider-managed cache. [7] | `50` |
...
| [`gen_ai.usage.cache_creation_input_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | int | The number of input tokens written to a provider-managed cache. [10] | `25` |
...
**[7] `gen_ai.usage.cache_read_input_tokens`:** Subset of `gen_ai.usage.input_tokens`.

**[8] `gen_ai.usage.input_tokens`:** This value MUST include cached tokens (cache reads and cache writes) when the provider exposes them.
