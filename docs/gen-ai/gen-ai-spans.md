...
# Semantic Conventions for GenAI Client Spans
...
- [GenAI Operation Spans](#genai-operation-spans)
- [Capturing inputs and outputs](#capturing-inputs-and-outputs)

<!-- tocstop -->

## GenAI Operation Spans
...
This span represents client call to GenAI system.
