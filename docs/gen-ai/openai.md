...
| [`gen_ai.request.response_format`](/docs/attributes-registry/gen-ai.md) | string | The structured response format specified in the request. | `text`; `json_object`; `json_schema` | `Conditionally Required` [6] | ![Experimental](https://img.shields.io/badge/-experimental-blue) |
...
**[6] `gen_ai.request.response_format`:** when applicable and if the request includes a response_format
