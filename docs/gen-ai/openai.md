...
`gen_ai.system.name` MUST be set to `"openai"`.
...
| [`openai.request.service_tier`](/docs/attributes-registry/openai.md) | string | The service tier requested. May be a specific tier, default, or auto. | `auto`; `default` | `Conditionally Required` [6] | ![Development](https://img.shields.io/badge/-development-blue) |
| [`openai.response.service_tier`](/docs/attributes-registry/openai.md) | string | The service tier used for the response. | `scale`; `default` | `Conditionally Required` [7] | ![Development](https://img.shields.io/badge/-development-blue) |
...
| [`openai.response.system_fingerprint`](/docs/attributes-registry/openai.md) | string | A fingerprint to track any eventual change in the Generative AI environment. | `fp_44709d6fcb` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
...
**[4] `gen_ai.output.type`:** This attribute SHOULD be set to the output type requested by the client: - `json` for structured outputs with defined or undefined schema - `image` for image output - `speech` for speech output - `text` for plain text output
...
**[6] `openai.request.service_tier`:** if the request includes a service_tier and the value is not 'auto'
...
| Attribute  | Type | Description  | Examples  | [Requirement Level](https://opentelemetry.io/docs/specs/semconv/general/attribute-requirement-level/) | Stability |
|---|---|---|---|---|---|
| [`openai.response.service_tier`](/docs/attributes-registry/openai.md) | string | The service tier used for the response. | `scale`; `default` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
| [`openai.response.system_fingerprint`](/docs/attributes-registry/openai.md) | string | A fingerprint to track any eventual change in the Generative AI environment. | `fp_44709d6fcb` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
