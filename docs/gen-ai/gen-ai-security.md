...
| [`gen_ai.security.content.modified`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Conditionally Required` if `gen_ai.security.decision.type` is `modify` | boolean | Whether the content was modified by the guardrail (e.g., redacted, sanitized, rewritten). | `true`; `false` |
