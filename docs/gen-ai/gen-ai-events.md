...
| [`gen_ai.usage.cache_read_input_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | int | The number of input tokens served from a provider-managed cache. [9] | `50` |
...
| [`gen_ai.usage.cache_creation_input_tokens`](/docs/registry/attributes/gen-ai.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | int | The number of input tokens written to a provider-managed cache. [16] | `25` |
...
**[9] `gen_ai.usage.cache_read_input_tokens`:** Subset of `gen_ai.usage.input_tokens`.

**[10] `gen_ai.usage.input_tokens`:** When normalizing provider responses:
