...
The conventions described in this section are specific to Generative AI applications.

**Disclaimer:** These are initial Generative AI workflow metric instruments
and attributes but more may be added in the future.

The following metric instruments describe an operation that executes a coordinated process
