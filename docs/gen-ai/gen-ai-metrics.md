...
- [Generative AI client metrics](#generative-ai-client-metrics)
  ...
  - [Metric: `gen_ai.client.agent.active`](#metric-gen_aiclientactive_agents)
...
| Name     | Instrument Type | Unit (UCUM) | Description    | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `gen_ai.client.agent.active` | UpDownCounter | `1` | Number of active agents currently running in the system. | ![Development](https://img.shields.io/badge/-development-blue) |  |
