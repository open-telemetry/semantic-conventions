...
- [Generative AI workflow metrics](#generative-ai-client-metrics)
  - [Metric: `gen_ai.workflow.token.usage`](#metric-gen_aiworkflowtokenusage)
  - [Metric: `gen_ai.workflow.operation.duration`](#metric-gen_aiworkflowoperationduration)
...
### Metric: `gen_ai.workflow.operation.duration`
...
| Name                            | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
|---------------------------------| --------------- | ----------- | -------------- | --------- | ------ |
| `gen_ai.client.workflow.duration` | Histogram | `s` | GenAI operation duration. | ![Development](https://img.shields.io/badge/-development-blue) | |

**Attributes:**

| Key                                                            | Stability | [Requirement Level](https://opentelemetry.io/docs/specs/semconv/general/attribute-requirement-level/) | Value Type | Description                                              | Example Values |
|----------------------------------------------------------------| --- | --- | --- |----------------------------------------------------------| --- |
| [`gen_ai.workflow.name`](/docs/registry/attributes/gen-ai.md)  | ![Development](https://img.shields.io/badge/-development-blue) | `Required` | string | The name of the operation being performed.               | `chat`; `generate_content`; `text_completion` |
