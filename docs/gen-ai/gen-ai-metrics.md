...
### Metric: `gen_ai.server.cache_hit_rate`

This metric is [recommended][MetricRecommended] to report the cache hit rate of the model service for any model servers which support serving LLMs. It is measured by dividing the number of hited prompt tokens from the cache by the total number of prompt tokens. This is important in evaluating the efficiency of the caching mechanism, as a higher cache hit rate indicates better utilization of cached results and reduced computational overhead during inference.

<!-- semconv metric.gen_ai.server.cache_hit_rate -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
<!-- markdownlint-capture -->
...
| -------- | --------------- | ----------- | -------------- | --------- |
| `gen_ai.server.cache_hit_rate` | Gauge | `1` | Cache hit rate of the model service | ![Development](https://img.shields.io/badge/-development-blue) |
...
### Metric: `gen_ai.server.cached_tokens_total`

This metric is [recommended][MetricRecommended] to report the number of tokens stored in the cache of the model service for any model servers which support serving LLMs. It is measured by counting the total number of tokens currently cached across all entries in the model service's cache. This is important in understanding the capacity and usage of the cache, as it helps optimize memory allocation and improve the performance of token retrieval during inference.

<!-- semconv metric.gen_ai.server.cached_tokens_total -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
<!-- markdownlint-capture -->
...
| Name     | Instrument Type | Unit (UCUM) | Description    | Stability |
| -------- | --------------- | ----------- | -------------- | --------- |
| `gen_ai.server.cached_tokens_total` | Counter | `{token}` | Count of cached prompt tokens | ![Development](https://img.shields.io/badge/-development-blue) |
