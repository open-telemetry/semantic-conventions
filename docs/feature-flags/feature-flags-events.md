...
The table below indicates which attributes should be added to the [Event](https://opentelemetry.io/docs/specs/otel/logs/data-model/#log-and-event-record-definition) and their types.
