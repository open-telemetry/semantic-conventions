...
- [Messaging client operation exception](#messaging-client-operation-exception)
- [Messaging process exception](#messaging-process-exception)

<!-- tocstop -->

## Messaging client operation exception

<!-- semconv event.messaging.client.operation.exception -->
...
The event name MUST be `messaging.client.operation.exception`.
