...
# Semantic conventions for IBM MQ

**Status**: [Development][DocumentStatus]

<!-- START doctoc -->

- [IBM MQ spans](#ibm-mq-spans)
...
The Semantic Conventions for [IBM MQ](https://www.ibm.com/products/mq) extend and override the [Messaging Semantic Conventions](README.md).
...
<!-- semconv span.messaging.ibmmq.send.producer -->
...
Describes a producer sending one or more messages to IBM MQ.
...
| [`messaging.system`](/docs/registry/attributes/messaging.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Required` | string | The messaging system as identified by the client instrumentation. [1] | `ibmmq` |
| [`error.type`](/docs/registry/attributes/error.md) | ![Stable](https://img.shields.io/badge/-stable-lightgreen) | `Conditionally Required` If and only if the messaging operation has failed. | string | Describes a class of error the operation ended with. [2] | `MQRC_Q_FULL`; `MQRC_NOT_AUTHORIZED`; `MQRC_CONNECTION_BROKEN` |
...
| [`messaging.ibmmq.queue_manager.id`](/docs/registry/attributes/messaging.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | The Queue Manager Identifier (QMID), a queue manager attribute generated by IBM MQ when the queue manager is created, formatted as `<QUEUE_MANAGER_NAME>_YYYY-MM-DD_HH.MM.SS`. The value reported MUST have the trailing padding removed. [10] | `QM1_2026-08-10_23.23.00` |
...
**[1] `messaging.system`:** MUST be set to `"ibmmq"`.
...
**[10] `messaging.ibmmq.queue_manager.id`:** The queue manager that accepted the message, which is the queue manager the client is connected to. When the destination is a remote queue definition or a clustered queue, the message may subsequently be routed to a different queue manager, so this identifies the point of ingress rather than the queue manager hosting the queue.
...
<!-- semconv span.messaging.ibmmq.receive.client -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
Describes a consumer receiving one or more messages from IBM MQ (pull-based).
...
**[10] `messaging.ibmmq.queue_manager.id`:** The queue manager the message was retrieved from. A get is always local to the queue manager the client is connected to, so this unambiguously identifies the queue manager that held the message.
...
<!-- semconv span.messaging.ibmmq.process.consumer -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
Describes a consumer processing one or more messages from IBM MQ (push-based).
