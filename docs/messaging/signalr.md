...
# Semantic conventions for SignalR

**Status**: [Development][DocumentStatus]

The Semantic Conventions for SignalR extend and override the [Messaging Semantic Conventions](README.md).

<!-- semconv messaging.signalr -->
...
| [`messaging.destination.name`](/docs/registry/attributes/messaging.md) | string | The hub method name which is being invoked. [2] | `MyQueue`; `MyTopic` | `Conditionally Required` [3] | ![Development](https://img.shields.io/badge/-development-blue) |
...
| [`url.path`](/docs/registry/attributes/url.md) | string | The [URI path](https://www.rfc-editor.org/rfc/rfc3986#section-3.3) component [7] | `/search` | `Recommended` | ![Stable](https://img.shields.io/badge/-stable-lightgreen) |
...
**[7] `url.path`:** Sensitive content provided in `url.path` SHOULD be scrubbed when instrumentations can identify it.
