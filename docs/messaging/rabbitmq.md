...
| [`rabbitmq.destination.routing_key`](/docs/attributes-registry/rabbitmq.md) | string | RabbitMQ message routing key. | `myKey` | `Conditionally Required` If not empty. | ![Experimental](https://img.shields.io/badge/-experimental-blue) |
| [`rabbitmq.message.delivery_tag`](/docs/attributes-registry/rabbitmq.md) | int | RabbitMQ message delivery tag | `123` | `Conditionally Required` When available. | ![Experimental](https://img.shields.io/badge/-experimental-blue) |
