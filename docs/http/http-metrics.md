...
<!--- comments between \<!-- semconv ... --\> and  endsemconv  are generated by YAML and shouldn't 
be edited in this file. For more information, see
https://github.com/open-telemetry/semantic-conventions/blob/main/CONTRIBUTING.md#yaml-to-markdown
--->
