...
### Metric: `http.server.time_to_first_event`
<!-- semconv metric.http.server.time_to_first_event -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
<!-- markdownlint-capture -->
...
| Name     | Instrument Type | Unit (UCUM) | Description    | Stability |
| -------- | --------------- | ----------- | -------------- | --------- |
| `rpc.server.time_to_first_event` | Histogram | `s` | Time to send first event for all events [1] | ![Development](https://img.shields.io/badge/-development-blue) |

**[1]:** **Streaming**: This metric is only required for SSE
...
### Metric: `http.server.time_per_event`
<!-- semconv metric.http.server.time_per_event -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
<!-- markdownlint-capture -->
...
| Name     | Instrument Type | Unit (UCUM) | Description    | Stability |
| -------- | --------------- | ----------- | -------------- | --------- |
| `rpc.server.time_per_event` | Histogram | `s` | Time per event after the first sent event [1] | ![Development](https://img.shields.io/badge/-development-blue) |
