...
HTTP spans MUST follow the overall [guidelines for span names](https://github.com/open-telemetry/opentelemetry-specification/blob/v1.59.0/specification/trace/api.md#span).
...
[Span Status](https://github.com/open-telemetry/opentelemetry-specification/blob/v1.59.0/specification/trace/api.md#set-status) MUST be left unset if HTTP status code was in the
...
| [`synthetic.type`](/docs/registry/attributes/synthetic.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | string | Specifies the category of synthetic traffic, such as tests or bots. [14] | `bot`; `test` |
...
| [`url.template`](/docs/registry/attributes/url.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | string | The low-cardinality template of an [absolute path reference](https://www.rfc-editor.org/rfc/rfc3986#section-4.2). [15] | `/users/{id}`; `/users/:id`; `/users?id={id}` |
...
| [`user_agent.synthetic.type`](/docs/registry/attributes/user-agent.md) | ![Deprecated](https://img.shields.io/badge/-deprecated-red)<br>Replaced by `synthetic.type`. | `Opt-In` | string | Deprecated, use `synthetic.type` instead. | `bot`; `test` |
...
**[15] `url.template`:** The `url.template` MUST have low cardinality. It is not usually available on HTTP clients, but may be known by the application or specialized HTTP instrumentation.
...
| [`synthetic.type`](/docs/registry/attributes/synthetic.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | string | Specifies the category of synthetic traffic, such as tests or bots. [18] | `bot`; `test` |
| [`user_agent.synthetic.type`](/docs/registry/attributes/user-agent.md) | ![Deprecated](https://img.shields.io/badge/-deprecated-red)<br>Replaced by `synthetic.type`. | `Opt-In` | string | Deprecated, use `synthetic.type` instead. | `bot`; `test` |
...
**[18] `synthetic.type`:** Components that populate the attribute are responsible for determining what they consider to be synthetic bot or test traffic. This attribute can either be set for self-identification purposes, or on telemetry detected to be generated as a result of a synthetic request. This attribute is useful for distinguishing between genuine client traffic and synthetic traffic generated by bots or tests.
