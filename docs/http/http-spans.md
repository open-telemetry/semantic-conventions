...
HTTP spans MUST follow the overall [guidelines for span names](https://github.com/open-telemetry/opentelemetry-specification/tree/v1.50.0/specification/trace/api.md#span).
...
[Span Status](https://github.com/open-telemetry/opentelemetry-specification/tree/v1.50.0/specification/trace/api.md#set-status) MUST be left unset if HTTP status code was in the
...
[SpanProcessor]: https://github.com/open-telemetry/opentelemetry-specification/tree/v1.50.0/specification/trace/sdk.md#span-processor
