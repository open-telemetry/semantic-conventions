...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `jvm.file_descriptor.count` | UpDownCounter | `{file_descriptor}` | Number of open file descriptors as reported by the JVM. | ![Stable](https://img.shields.io/badge/-stable-lightgreen) | |
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `jvm.file_descriptor.limit` | UpDownCounter | `{file_descriptor}` | Measure of max open file descriptors as reported by the JVM. | ![Stable](https://img.shields.io/badge/-stable-lightgreen) | |
