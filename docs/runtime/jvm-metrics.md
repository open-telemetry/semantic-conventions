...
| [`jvm.thread.state`](/docs/attributes-registry/jvm.md) | string | State of the thread. | `new`; `runnable`; `blocked` | `Recommended` | ![Stable](https://img.shields.io/badge/-stable-lightgreen) |
