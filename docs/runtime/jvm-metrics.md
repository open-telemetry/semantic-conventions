...
- [JVM executors](#jvm-executors)
  ...
  - [Metric: `jvm.executor.thread.max`](#metric-jvmexecutorthreadmax)
  - [Metric: `jvm.executor.queue.size`](#metric-jvmexecutorqueuesize)
  - [Metric: `jvm.executor.queue.remaining`](#metric-jvmexecutorqueueremaining)
...
This metric SHOULD be specified with [`ExplicitBucketBoundaries` advisory parameter](https://github.com/open-telemetry/opentelemetry-specification/blob/v1.59.0/specification/metrics/api.md#instrument-advisory-parameters) of `[ 0.01, 0.1, 1, 10 ]`.
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `jvm.executor.thread.count` | UpDownCounter | `{thread}` | The number of executor threads that are currently in the state described by the `jvm.executor.state` attribute. | ![Development](https://img.shields.io/badge/-development-blue) | |
...
| [`jvm.executor.state`](/docs/registry/attributes/jvm.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Required` | string | State of an executor thread. | `active`; `idle` |
...
### Metric: `jvm.executor.thread.max`

This metric is [recommended][MetricRecommended].

<!-- semconv metric.jvm.executor.thread.max -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
### Metric: `jvm.executor.queue.remaining`

This metric is [recommended][MetricRecommended].

<!-- semconv metric.jvm.executor.queue.remaining -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `jvm.executor.queue.remaining` | UpDownCounter | `{task}` | The remaining task capacity of the executor queue. [1] | ![Development](https://img.shields.io/badge/-development-blue) | |
...
| Name | Instrument Type | Unit (UCUM) | Description | Stability | Entity Associations |
| -------- | --------------- | ----------- | -------------- | --------- | ------ |
| `jvm.executor.task.completed` | Counter | `{task}` | The number of tasks completed by the executor. | ![Development](https://img.shields.io/badge/-development-blue) | |
