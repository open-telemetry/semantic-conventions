...
| --- | --- | --- | --- | --- | --- |
| [`nodejs.eventloop.state`](attributes/nodejs.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Required` | string | The state of event loop time. | `active`; `idle` |
