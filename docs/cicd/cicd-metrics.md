...
| [`vcs.vendor.name`](/docs/attributes-registry/vcs.md) | string | The vendor name of the version control system. | `github`; `gitlab`; `gittea`; `bitbucket` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
