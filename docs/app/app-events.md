...
- [Event: `app.screen.time_on_screen`](#event-appscreentime_on_screen)
...
## Event: `app.screen.time_on_screen`

<!-- semconv event.app.screen.time_on_screen -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
<!-- markdownlint-capture -->
...
The event name MUST be `app.screen.time_on_screen`.
