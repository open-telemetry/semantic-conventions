...
| [`exception.type`](/docs/registry/attributes/exception.md) | ![Stable](https://img.shields.io/badge/-stable-lightgreen) | `Recommended` | string | If this contains obfuscated symbols, `app.build_id` SHOULD be provided so they can be deobfuscated. [7] | `java.net.ConnectException`; `OSError` |
...
**[7] `exception.type`:** If the recorded exception type is a wrapper that is not meaningful for
