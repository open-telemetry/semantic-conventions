...
| [`app.activity.name`](/docs/registry/attributes/app.md) | string | The name of the Activity at the time of the event or span start. [2] | `myActivity`; `checkout` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
