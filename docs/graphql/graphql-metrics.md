...
For subscription operations, the response is complete when the
subscription terminates. This metric therefore records the full
subscription duration, not only the initial subscription setup.
...
For subscription operations, the request remains active until the
