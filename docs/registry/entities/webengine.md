...
| `resource.attributes[]` | `Opt-In` | User Defined Resource | - name: webengine.description,<br>&nbsp;&nbsp;&nbsp;type:string,<br>&nbsp;&nbsp;&nbsp;value:  WildFly Full 21.0.0.Final (WildFly Core 13.0.1.Final) - 2.2.2.Final | [`webengine.description`](/docs/registry/attributes/.md) |
...
| `resource.attributes[]` | `Opt-In` | User Defined Resource | - name: webengine.name,<br>&nbsp;&nbsp;&nbsp;type:string,<br>&nbsp;&nbsp;&nbsp;value:  WildFly | [`webengine.name`](/docs/registry/attributes/.md) |
...
| `resource.attributes[]` | `Opt-In` | User Defined Resource | - name: webengine.version,<br>&nbsp;&nbsp;&nbsp;type:string,<br>&nbsp;&nbsp;&nbsp;value:  21.0.0 | [`webengine.version`](/docs/registry/attributes/.md) |
