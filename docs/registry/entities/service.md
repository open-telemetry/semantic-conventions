...
| `resource.attributes[]` | `Opt-In` | User Defined Resource | - name: service.name,<br>&nbsp;&nbsp;&nbsp;type:string,<br>&nbsp;&nbsp;&nbsp;value:  shoppingcart | [`service.name`](/docs/registry/attributes/.md) |
...
| `resource.attributes[]` | `Opt-In` | User Defined Resource | - name: service.version,<br>&nbsp;&nbsp;&nbsp;type:string,<br>&nbsp;&nbsp;&nbsp;value:  2.0.0 | [`service.version`](/docs/registry/attributes/.md) |
...
| `resource.attributes[]` | `Opt-In` | User Defined Resource | - name: service.instance.id,<br>&nbsp;&nbsp;&nbsp;type:string,<br>&nbsp;&nbsp;&nbsp;value:  627cc493-f310-47de-96bd-71410b7dec09 | [`service.instance.id`](/docs/registry/attributes/.md) |
...
| `resource.attributes[]` | `Opt-In` | User Defined Resource | - name: service.namespace,<br>&nbsp;&nbsp;&nbsp;type:string,<br>&nbsp;&nbsp;&nbsp;value:  Shop | [`service.namespace`](/docs/registry/attributes/.md) |
