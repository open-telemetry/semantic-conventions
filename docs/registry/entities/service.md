...
| Role | Key | Stability | [Requirement Level](https://opentelemetry.io/docs/specs/semconv/general/attribute-requirement-level/) | Value Type | Description | Example Values |
| --- | --- | --- | --- | --- | --- | --- |
| Identity | [`service.owner.name`](/docs/registry/attributes/service.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Required` | string | The name of the team or individual responsible for the service. [4] | `Checkout Team`; `Platform Infrastructure`; `john.doe` |
| Description | [`service.owner.contact`](/docs/registry/attributes/service.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | The contact point or communication channel for the team responsible for the service. [5] | `https://example.slack.com/channels/checkout-team`; `#checkout-team`; `checkout-team@example.com` |
...
**[4] `service.owner.name`:** This attribute is used to identify the organizational owner of a service,
...
**[5] `service.owner.contact`:** This attribute provides a way to reach the team or individual responsible for the service.
