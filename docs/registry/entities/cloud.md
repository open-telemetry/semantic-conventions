...
| [`cloud.platform`](/docs/registry/attributes/cloud.md) | string | The cloud platform in use. [2] | `akamai.cloud_compute`; `alibaba_cloud_ecs`; `alibaba_cloud_fc` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
| [`cloud.provider`](/docs/registry/attributes/cloud.md) | string | Name of the cloud provider. | `akamai`; `alibaba_cloud`; `aws` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
...
|---|---|---|
| `akamai.cloud_compute` | Akamai Cloud Compute (Linode) | ![Development](https://img.shields.io/badge/-development-blue) |
...
| Value  | Description | Stability |
|---|---|---|
| `akamai` | Akamai | ![Development](https://img.shields.io/badge/-development-blue) |
