...
| [`gcp.gce.instance.labels.<key>`](/docs/registry/attributes/gcp.md) | string | GCE instance labels, `<key>` being the label name and the value being the label value. [5] | `observability` | `Opt-In` | ![Development](https://img.shields.io/badge/-development-blue) |
