...
| [`process.title`](/docs/registry/attributes/process.md) | string | Process title (proctitle) [3] | `cat /etc/hostname`; `xfce4-session`; `bash` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
