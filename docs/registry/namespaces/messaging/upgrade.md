...
| --- | --- | --- | --- |
| messaging.publish.duration | Unknown | messaging.client.operation.duration | Replaced by `messaging.client.operation.duration`. |
| messaging.receive.duration | Unknown | messaging.client.operation.duration | Replaced by `messaging.client.operation.duration`. |
| messaging.process.messages | Unknown | messaging.client.consumed.messages | Replaced by `messaging.client.consumed.messages`. |
| messaging.publish.messages | Unknown | messaging.client.sent.messages | Replaced by `messaging.client.sent.messages`. |
| messaging.receive.messages | Unknown | messaging.client.consumed.messages | Replaced by `messaging.client.consumed.messages`. |
| messaging.client.published.messages | Unknown | messaging.client.sent.messages | Replaced by `messaging.client.sent.messages`. |
