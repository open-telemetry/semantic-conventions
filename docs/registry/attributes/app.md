...
| <a id="app-roles" href="#app-roles">`app.roles`</a> | string[] | What role this app can perform. [5] | `["ui", "background_tasks"]`; `["background_tasks", "console"]` | ![Development](https://img.shields.io/badge/-development-blue) |
