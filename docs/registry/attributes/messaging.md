...
| <a id="messaging-system" href="#messaging-system">`messaging.system`</a> | string | The messaging system as identified by the client instrumentation. [12] | `activemq`; `aws.sns`; `aws_sqs` | ![Development](https://img.shields.io/badge/-development-blue) |
