...
| --- | --- | --- | --- | --- |
| <a id="service-cost-center-id" href="#service-cost-center-id">`service.cost_center.id`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | Identifier of the cost center associated with the service. [1] | `94002`; `engineering-platform`; `marketing-campaigns-2026` |
...
**[1] `service.cost_center.id`:** The cost center identifier enables tracking and attribution of service resource costs to organizational units or teams. This standardization ensures consistent cost allocation across cloud providers, Kubernetes clusters, and observability platforms.
...
| --- | --- | --- |
| `critical` | Service is business-critical; downtime directly impacts revenue, user experience, or core functionality. [6] | ![Development](https://img.shields.io/badge/-development-blue) |
| `high` | Service is important but has degradation tolerance or fallback mechanisms. [7] | ![Development](https://img.shields.io/badge/-development-blue) |
| `low` | Service is non-essential to core operations; used for background tasks or internal tools. [8] | ![Development](https://img.shields.io/badge/-development-blue) |
| `medium` | Service provides supplementary functionality; degradation has limited user impact. [9] | ![Development](https://img.shields.io/badge/-development-blue) |
