...
| <a id="service-peer-namespace" href="#service-peer-namespace">`service.peer.namespace`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | A namespace for `service.peer.name`. SHOULD be equal to the actual [`service.namespace`](/docs/resource/README.md#service) resource attribute of the remote service if any. | `Shop` |
