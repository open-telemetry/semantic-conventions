...
| <a id="service-peer-namespace" href="#service-peer-namespace">`service.peer.namespace`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | A namespace for `service.peer.name`. | `Shop` |
