...
| <a id="browser-document-url-full" href="#browser-document-url-full">`browser.document.url.full`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | Absolute URL of the current document according to [RFC3986](https://www.rfc-editor.org/rfc/rfc3986). | `https://www.example.com/search?q=OpenTelemetry#SemConv` |
