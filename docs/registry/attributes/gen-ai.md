...
| <a id="gen-ai-agent-role" href="#gen-ai-agent-role">`gen_ai.agent.role`</a> | string | Role of the agent in the given operation context. | `researcher`; `coder`; `assistant` | ![Development](https://img.shields.io/badge/-development-blue) |
...
| <a id="gen-ai-request-logprobs" href="#gen-ai-request-logprobs">`gen_ai.request.logprobs`</a> | boolean | Whether to return the log probabilities for each token in the response. | `true` | ![Development](https://img.shields.io/badge/-development-blue) |
