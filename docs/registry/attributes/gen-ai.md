...
| <a id="gen-ai-evaluation-metadata" href="#gen-ai-evaluation-metadata">`gen_ai.evaluation.metadata`</a> | string | Additional metadata associated with the evaluation. [2] | `{\"evaluator_version\": \"1.2.0\", \"gen_ai.thread.id\": \"thread_ggguJ0iZXRPjUnCy9vT9Fdvs\"}` | ![Development](https://img.shields.io/badge/-development-blue) |
| <a id="gen-ai-evaluation-name" href="#gen-ai-evaluation-name">`gen_ai.evaluation.name`</a> | string | The qualified name of the evaluator used to evaluate the GenAI response. [3] | `Relevance`; `IntentResolution` | ![Development](https://img.shields.io/badge/-development-blue) |
...
| <a id="gen-ai-evaluation-score" href="#gen-ai-evaluation-score">`gen_ai.evaluation.score`</a> | double | The evaluation score for the GenAI response. | `4.0` | ![Development](https://img.shields.io/badge/-development-blue) |
| <a id="gen-ai-input-metadata" href="#gen-ai-input-metadata">`gen_ai.input.metadata`</a> | string | Metadata associated with the GenAI input. [4] | `{\"requestId\": \"fab3ee5d-a3c6-4c47-b3de-901bf02fa045\"}` | ![Development](https://img.shields.io/badge/-development-blue) |
