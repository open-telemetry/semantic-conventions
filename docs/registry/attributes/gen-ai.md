...
| <a id="gen-ai-agent-invocation-trigger" href="#gen-ai-agent-invocation-trigger">`gen_ai.agent.invocation.trigger`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | Indicates what triggered the agent invocation. | `direct`; `agent` |
