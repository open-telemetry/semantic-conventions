...
| <a id="gen-ai-agent-invocation-trigger" href="#gen-ai-agent-invocation-trigger">`gen_ai.agent.invocation.trigger`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | Indicates what triggered the agent invocation. [1] | `direct`; `agent` |
...
**[1] `gen_ai.agent.invocation.trigger`:** This attribute distinguishes whether an agent was invoked directly
