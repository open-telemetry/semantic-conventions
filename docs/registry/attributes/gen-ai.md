...
| <a id="gen-ai-memory-store-name" href="#gen-ai-memory-store-name">`gen_ai.memory.store.name`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | Human-readable name of the memory store. [7] | `Customer Support Memory`; `Shopping Preferences` |
...
| `delete_memory` | Delete memory items | ![Development](https://img.shields.io/badge/-development-blue) |
