...
| <a id="gen-ai-browser-id" href="#gen-ai-browser-id">`gen_ai.browser.id`</a> | string | The unique identifier of the browser. | `myBrowser-a1b2c3d4e5` | ![Development](https://img.shields.io/badge/-development-blue) |
...
| <a id="gen-ai-gateway-id" href="#gen-ai-gateway-id">`gen_ai.gateway.id`</a> | string | The unique identifier of the gateway. | `mygateway-a1b2c3d4e5` | ![Development](https://img.shields.io/badge/-development-blue) |
...
| <a id="gen-ai-memory-id" href="#gen-ai-memory-id">`gen_ai.memory.id`</a> | string | The unique identifier of the memory. | `myMemory-a1b2c3d4e5` | ![Development](https://img.shields.io/badge/-development-blue) |
...
| <a id="gen-ai-runtime-id" href="#gen-ai-runtime-id">`gen_ai.runtime.id`</a> | string | The unique identifier of the runtime. | `myRuntime-a1b2c3d4e5` | ![Development](https://img.shields.io/badge/-development-blue) |
