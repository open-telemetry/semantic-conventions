...
**[3] `gen_ai.orchestrator.agent_definitions`:** This attribute contains an array of objects representing agent definitions that are
available to the orchestrator for potential use in multi-agent workflows.
