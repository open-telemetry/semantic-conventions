...
| <a id="gen-ai-workflow-name" href="#gen-ai-workflow-name">`gen_ai.workflow.name`</a>                                        | ![Development](https://img.shields.io/badge/-development-blue) | string     | Name/identifier of the workflow.                                               |  `multi_agent_rag`; `customer_support_pipeline` |
| <a id="gen-ai-workflow-description" href="#gen-ai-workflow-description">`gen_ai.workflow.description`</a>                   | ![Development](https://img.shields.io/badge/-development-blue) | string     | Description of the workflow.                                                   |  `This is multiple agent RAG workflow`; `This is customer support pipeline workflow`|
| <a id="gen-ai-framework" href="#gen-ai-framework">`gen_ai.framework`</a>                                                    | ![Development](https://img.shields.io/badge/-development-blue) | string     | Framework implementing the workflow.                                           |  `LangGraph`; `CrewAI`; `OpenAI agents`   |
| <a id="gen-ai-step-name" href="#gen-ai-step-name">`gen_ai.step.name`</a>                                                    | ![Development](https://img.shields.io/badge/-development-blue) | string     | Name/identifier of the step.                                                   |  `should_continue`; `project_task` |
| <a id="gen-ai-step-description" href="#gen-ai-step-description">`gen_ai.step.description`</a>                               | ![Development](https://img.shields.io/badge/-development-blue) | string     | Description of the step.                                                       |  `Create a comprehensive market analysis report with recommendations`;|
| <a id="gen-ai-step-objective" href="#gen-ai-step-objective">`gen_ai.step.objective`</a>                                     | ![Development](https://img.shields.io/badge/-development-blue) | string     | What the step aims to achieve.                                                 |  `Executive summary, detailed analysis, and strategic recommendations`|
| <a id="gen-ai-step-assigned_agents" href="#gen-ai-step-assigned_agents">`gen_ai.step.assigned_agents`</a>                   | ![Development](https://img.shields.io/badge/-development-blue) | string[]   | Name of agents assigned to execute the step.                                   |  `researcher`; `writer`|
