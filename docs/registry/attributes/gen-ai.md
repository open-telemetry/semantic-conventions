...
| <a id="gen-ai-retrieval-documents-retrieved" href="#gen-ai-retrieval-documents-retrieved">`gen_ai.retrieval.documents_retrieved`</a> | int | The number of documents retrieved. | `5`; `10` | ![Development](https://img.shields.io/badge/-development-blue) |
| <a id="gen-ai-retrieval-top-k" href="#gen-ai-retrieval-top-k">`gen_ai.retrieval.top_k`</a> | int | The number of documents to retrieve. | `5`; `10` | ![Development](https://img.shields.io/badge/-development-blue) |
| <a id="gen-ai-retrieval-type" href="#gen-ai-retrieval-type">`gen_ai.retrieval.type`</a> | string | The type of retrieval being performed. | `similarity`; `hybrid` | ![Development](https://img.shields.io/badge/-development-blue) |
| <a id="gen-ai-retrieval-vector-store" href="#gen-ai-retrieval-vector-store">`gen_ai.retrieval.vector_store`</a> | string | The vector store being used for retrieval. | `faiss`; `pinecone` | ![Development](https://img.shields.io/badge/-development-blue) |
