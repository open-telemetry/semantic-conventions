...
| <a id="gen-ai-agent-type" href="#gen-ai-agent-type">`gen_ai.agent.type`</a> | string | Agent type here specify standard types or styles or patterns of Agentic applications - ReACT, CoT, RAG, and other evolving agentic patterns. | `RAG or ReACT or CoT or any other user defined style or pattern or type` | ![Development](https://img.shields.io/badge/-development-blue) |
