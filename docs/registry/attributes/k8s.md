...
| <a id="k8s-container-ephemeral-storage-fs-type" href="#k8s-container-ephemeral-storage-fs-type">`k8s.container.ephemeral_storage.fs_type`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The type of file system component for ephemeral storage. [2] | `rootfs`; `logs` [(see all values)](#k8s-container-ephemeral-storage-fs-type-values) |
...
| <a id="k8s-namespace-phase" href="#k8s-namespace-phase">`k8s.namespace.phase`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The phase of the K8s namespace. [17] | `active`; `terminating` [(see all values)](#k8s-namespace-phase-values) |
...
| <a id="k8s-node-condition-status" href="#k8s-node-condition-status">`k8s.node.condition.status`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The status of the condition, one of True, False, Unknown. [19] | `true`; `false`; `unknown` [(see all values)](#k8s-node-condition-status-values) |
| <a id="k8s-node-condition-type" href="#k8s-node-condition-type">`k8s.node.condition.type`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The condition type of a K8s Node. [20] | `Ready`; `DiskPressure` [(see all values)](#k8s-node-condition-type-values) |
...
| <a id="k8s-persistentvolume-reclaim-policy" href="#k8s-persistentvolume-reclaim-policy">`k8s.persistentvolume.reclaim_policy`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The reclaim policy of the PersistentVolume. [24] | `Delete`; `Retain`; `Recycle` [(see all values)](#k8s-persistentvolume-reclaim-policy-values) |
| <a id="k8s-persistentvolume-status-phase" href="#k8s-persistentvolume-status-phase">`k8s.persistentvolume.status.phase`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The phase of the PersistentVolume. [25] | `Pending`; `Available`; `Bound`; `Released`; `Failed` [(see all values)](#k8s-persistentvolume-status-phase-values) |
...
| <a id="k8s-persistentvolumeclaim-status-phase" href="#k8s-persistentvolumeclaim-status-phase">`k8s.persistentvolumeclaim.status.phase`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The phase of the PersistentVolumeClaim. [28] | `Pending`; `Bound`; `Lost` [(see all values)](#k8s-persistentvolumeclaim-status-phase-values) |
...
| <a id="k8s-service-endpoint-address-type" href="#k8s-service-endpoint-address-type">`k8s.service.endpoint.address_type`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The address type of the service endpoint. [38] | `IPv4`; `IPv6` [(see all values)](#k8s-service-endpoint-address-type-values) |
| <a id="k8s-service-endpoint-condition" href="#k8s-service-endpoint-condition">`k8s.service.endpoint.condition`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The condition of the service endpoint. [39] | `ready`; `serving`; `terminating` [(see all values)](#k8s-service-endpoint-condition-values) |
...
| <a id="k8s-service-type" href="#k8s-service-type">`k8s.service.type`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The type of the Kubernetes Service. [45] | `ClusterIP`; `NodePort`; `LoadBalancer` [(see all values)](#k8s-service-type-values) |
...
| <a id="k8s-volume-type" href="#k8s-volume-type">`k8s.volume.type`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The type of the K8s volume. | `emptyDir`; `persistentVolumeClaim` [(see all values)](#k8s-volume-type-values) |
