...
| <a id="k8s-daemonset-annotation" href="#k8s-daemonset-annotation">`k8s.daemonset.annotation.<key>`</a> | string | The annotation key-value pairs placed on the DaemonSet. [3] | `k8s.daemonset.annotation.replicas=1`; `k8s.daemonset.annotation.data=` | ![Development](https://img.shields.io/badge/-development-blue) |
| <a id="k8s-daemonset-label" href="#k8s-daemonset-label">`k8s.daemonset.label.<key>`</a> | string | The label key-value pairs placed on the DaemonSet. [4] | `k8s.daemonset.label.app=guestbook`; `k8s.daemonset.label.injected=` | ![Development](https://img.shields.io/badge/-development-blue) |
...
| <a id="k8s-deployment-label" href="#k8s-deployment-label">`k8s.deployment.label.<key>`</a> | string | The label key-value pairs placed on the Deployment. [5] | `k8s.deployment.label.app=guestbook`; `k8s.deployment.label.injected=` | ![Development](https://img.shields.io/badge/-development-blue) |
...
| <a id="k8s-hpa-scaletargetref-api-version" href="#k8s-hpa-scaletargetref-api-version">`k8s.hpa.scaletargetref.api_version`</a> | string | The API version of the target resource to scale for the HorizontalPodAutoscaler. [6] | `apps/v1`; `autoscaling/v2` | ![Development](https://img.shields.io/badge/-development-blue) |
| <a id="k8s-hpa-scaletargetref-kind" href="#k8s-hpa-scaletargetref-kind">`k8s.hpa.scaletargetref.kind`</a> | string | The kind of the target resource to scale for the HorizontalPodAutoscaler. [7] | `Deployment`; `StatefulSet` | ![Development](https://img.shields.io/badge/-development-blue) |
| <a id="k8s-hpa-scaletargetref-name" href="#k8s-hpa-scaletargetref-name">`k8s.hpa.scaletargetref.name`</a> | string | The name of the target resource to scale for the HorizontalPodAutoscaler. [8] | `my-deployment`; `my-statefulset` | ![Development](https://img.shields.io/badge/-development-blue) |
...
**[3] `k8s.daemonset.annotation.<key>`:** The `<key>` being the annotation name, the value being the annotation value, even if the value is empty.

**[4] `k8s.daemonset.label.<key>`:** The `<key>` being the label name, the value being the label value, even if the value is empty.

**[5] `k8s.deployment.label.<key>`:** The `<key>` being the label name, the value being the label value, even if the value is empty.

**[6] `k8s.hpa.scaletargetref.api_version`:** This maps to the `apiVersion` field in the `scaleTargetRef` of the HPA spec.

**[7] `k8s.hpa.scaletargetref.kind`:** This maps to the `kind` field in the `scaleTargetRef` of the HPA spec.

**[8] `k8s.hpa.scaletargetref.name`:** This maps to the `name` field in the `scaleTargetRef` of the HPA spec.
...
| Attribute | Type | Description | Examples | Stability |
|---|---|---|---|---|
| <a id="k8s-cronjob-annotation" href="#k8s-cronjob-annotation">`k8s.cronjob.annotation.<key>`</a> | string | The cronjob annotation placed on the CronJob, the `<key>` being the annotation name, the value being the annotation value. [21] | `4`; `` | ![Deprecated](https://img.shields.io/badge/-deprecated-red)<br>Replaced by `workflow.task.annotation`. |
...
| <a id="k8s-job-annotation" href="#k8s-job-annotation">`k8s.job.annotation.<key>`</a> | string | The annotation key-value pairs placed on the Job. [23] | `k8s.job.annotation.number=1`; `k8s.job.annotation.data=` | ![Deprecated](https://img.shields.io/badge/-deprecated-red)<br>Replaced by `workflow.task.annotation`. |
...
**[21] `k8s.cronjob.annotation.<key>`:** Examples:
...
**[22] `k8s.deployment.annotation.<key>`:** The `<key>` being the annotation name, the value being the annotation value, even if the value is empty.

**[23] `k8s.job.annotation.<key>`:** The `<key>` being the annotation name, the value being the annotation value, even if the value is empty.
