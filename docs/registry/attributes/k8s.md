...
| <a id="k8s-container-ports" href="#k8s-container-ports">`k8s.container.ports`</a> | int[] | List of ports to expose from the container. | `[10053]`; `[8080, 8081]` | ![Development](https://img.shields.io/badge/-development-blue) |
