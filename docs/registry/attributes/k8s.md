...
| <a id="k8s-statefulset-annotation" href="#k8s-statefulset-annotation">`k8s.statefulset.annotation.<key>`</a> | ![Alpha](https://img.shields.io/badge/alpha-mediumpurple) | string | The annotation placed on the StatefulSet, the `<key>` being the annotation name, the value being the annotation value, even if the value is empty. [38] | `1`; `` |
| <a id="k8s-statefulset-label" href="#k8s-statefulset-label">`k8s.statefulset.label.<key>`</a> | ![Alpha](https://img.shields.io/badge/alpha-mediumpurple) | string | The label placed on the StatefulSet, the `<key>` being the label name, the value being the label value, even if the value is empty. [39] | `guestbook`; `` |
