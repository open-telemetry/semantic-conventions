...
| <a id="k8s-node-system-container-node-name" href="#k8s-node-system-container-node-name">`k8s.node.system_container.node_name`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The name of the Node the system container is running on. | `node-1` |
