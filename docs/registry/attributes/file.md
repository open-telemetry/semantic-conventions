...
| <a id="file-origin-url" href="#file-origin-url">`file.origin_url`</a> | string | The URL where the file is hosted. [8] | `http://example.com/imgs/article1_img.jpg` | ![Development](https://img.shields.io/badge/-development-blue) |
