...
| Key | Stability | Value Type | Description | Example Values |
| --- | --- | --- | --- | --- |
| <a id="file-lock-class" href="#file-lock-class">`file.lock.class`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | Class of lock or operation | `POSIX`; `FLOCK`; `DELEG`; `LEASE` |
