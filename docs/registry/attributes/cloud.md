...
| <a id="cloud-platform" href="#cloud-platform">`cloud.platform`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The cloud platform in use. [3] | `akamai_cloud.compute`; `alibaba_cloud_ecs`; `alibaba_cloud_fc` [(see all values)](#cloud-platform-values) |
| <a id="cloud-provider" href="#cloud-provider">`cloud.provider`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | Name of the cloud provider. | `akamai_cloud`; `alibaba_cloud`; `aws` [(see all values)](#cloud-provider-values) |
