...
| <a id="host-cpu-core-id" href="#host-cpu-core-id">`host.cpu.core.id`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The core identifier within a single CPU socket. | `0`; `1`; `2`; `3` |
...
| <a id="host-cpu-socket-id" href="#host-cpu-socket-id">`host.cpu.socket.id`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The CPU socket identifier. | `0`; `1` |
