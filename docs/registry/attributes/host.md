...
| <a id="host-platform-app-name" href="#host-platform-app-name">`host.platform.app.name`</a> | string | What product forms the basis of the hosting platform | `openshift`; `esxi`; `hyperv` | ![Development](https://img.shields.io/badge/-development-blue) |
...
| <a id="host-platform-provider" href="#host-platform-provider">`host.platform.provider`</a> | string | Name of the organisation providing the platform. | `alibaba`; `amazon`; `google` | ![Development](https://img.shields.io/badge/-development-blue) |
