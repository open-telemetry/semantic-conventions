...
| <a id="host-platform-product" href="#host-platform-product">`host.platform.product`</a> | string | What product forms the basis of the hosting platform | `openshift`; `esxi`; `hyperv` | ![Development](https://img.shields.io/badge/-development-blue) |
