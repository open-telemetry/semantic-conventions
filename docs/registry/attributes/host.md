...
| <a id="host-platform-description" href="#host-platform-description">`host.platform.description`</a> | string | The platform being used to host the computing instance. | `Azure VMWare Esxi` | ![Development](https://img.shields.io/badge/-development-blue) |
| <a id="host-platform-name" href="#host-platform-name">`host.platform.name`</a> | string | What product if any is being used to host the computing instance. | `openshift`; `esxi`; `hyperv` | ![Development](https://img.shields.io/badge/-development-blue) |
