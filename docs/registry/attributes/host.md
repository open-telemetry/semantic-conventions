...
| <a id="host-cpu-logical-count" href="#host-cpu-logical-count">`host.cpu.logical_count`</a> | ![Development](https://img.shields.io/badge/-development-blue) | int | Number of logical processor cores on the host. [1] | `8`; `64` |
...
| <a id="host-cpu-vendor-id" href="#host-cpu-vendor-id">`host.cpu.vendor.id`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | Processor manufacturer identifier. A maximum 12-character string. [2] | `GenuineIntel` |
