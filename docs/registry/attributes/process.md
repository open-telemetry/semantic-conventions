...
| <a id="process-executable-version" href="#process-executable-version">`process.executable.version`</a> | string | The file version of the process executable. | `1.0.1` | ![Development](https://img.shields.io/badge/-development-blue) |
