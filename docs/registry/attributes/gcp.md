...
| <a id="gcp-gce-instance-labels" href="#gcp-gce-instance-labels">`gcp.gce.instance.labels.<key>`</a> | string | GCE instance labels, `<key>` being the label name and the value being the label value. [6] | `observability` | ![Development](https://img.shields.io/badge/-development-blue) |
