...
| <a id="hw-battery-state" href="#hw-battery-state">`hw.battery.state`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The current state of the battery | `charging`; `discharging` [1] |
...
| <a id="hw-gpu-task" href="#hw-gpu-task">`hw.gpu.task`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | Type of task the GPU is performing | `decoder`; `encoder`; `general` [2] |
...
| <a id="hw-limit-type" href="#hw-limit-type">`hw.limit_type`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | Type of limit for hardware components | `critical`; `degraded`; `high.critical` [3] |
...
| <a id="hw-logical-disk-state" href="#hw-logical-disk-state">`hw.logical_disk.state`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | State of the logical disk space usage | `used`; `free` [4] |
...
| <a id="hw-physical-disk-state" href="#hw-physical-disk-state">`hw.physical_disk.state`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | State of the physical disk endurance utilization | `remaining` [5] |
...
| <a id="hw-state" href="#hw-state">`hw.state`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The current state of the component | `degraded`; `failed`; `needs_cleaning` [6] |
| <a id="hw-tape-drive-operation-type" href="#hw-tape-drive-operation-type">`hw.tape_drive.operation_type`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | Type of tape drive operation | `mount`; `unmount`; `clean` [7] |
