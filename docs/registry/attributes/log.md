...
| --- | --- | --- | --- | --- |
| <a id="log-iostream" href="#log-iostream">`log.iostream`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The stream the log record was emitted to. | `stdout`; `stderr` [(see more)](#log-iostream-values) |
