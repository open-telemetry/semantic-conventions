...
| <a id="network-io-compression" href="#network-io-compression">`network.io.compression`</a> | string | The network IO data compression. | `none`; `compressed` | ![Development](https://img.shields.io/badge/-development-blue) |
