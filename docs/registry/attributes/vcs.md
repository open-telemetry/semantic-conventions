...
| <a id="vcs-change-state" href="#vcs-change-state">`vcs.change.state`</a> | ![Release Candidate](https://img.shields.io/badge/-rc-mediumorchid) | string | The state of the change (pull request/merge request/changelist). | `open`; `closed`; `merged` [(see more)](#vcs-change-state-values) |
...
| <a id="vcs-line-change-type" href="#vcs-line-change-type">`vcs.line_change.type`</a> | ![Release Candidate](https://img.shields.io/badge/-rc-mediumorchid) | string | The type of line change being measured on a branch or change. | `added`; `removed` [(see more)](#vcs-line-change-type-values) |
...
| <a id="vcs-provider-name" href="#vcs-provider-name">`vcs.provider.name`</a> | ![Release Candidate](https://img.shields.io/badge/-rc-mediumorchid) | string | The name of the version control system provider. | `github`; `gitlab`; `gitea`; `bitbucket` [(see more)](#vcs-provider-name-values) |
...
| <a id="vcs-ref-base-type" href="#vcs-ref-base-type">`vcs.ref.base.type`</a> | ![Release Candidate](https://img.shields.io/badge/-rc-mediumorchid) | string | The type of the [reference](https://git-scm.com/docs/gitglossary#def_ref) in the repository. [3] | `branch`; `tag` [(see more)](#vcs-ref-base-type-values) |
...
| <a id="vcs-ref-head-type" href="#vcs-ref-head-type">`vcs.ref.head.type`</a> | ![Release Candidate](https://img.shields.io/badge/-rc-mediumorchid) | string | The type of the [reference](https://git-scm.com/docs/gitglossary#def_ref) in the repository. [6] | `branch`; `tag` [(see more)](#vcs-ref-head-type-values) |
| <a id="vcs-ref-type" href="#vcs-ref-type">`vcs.ref.type`</a> | ![Release Candidate](https://img.shields.io/badge/-rc-mediumorchid) | string | The type of the [reference](https://git-scm.com/docs/gitglossary#def_ref) in the repository. | `branch`; `tag` [(see more)](#vcs-ref-type-values) |
...
| <a id="vcs-revision-delta-direction" href="#vcs-revision-delta-direction">`vcs.revision_delta.direction`</a> | ![Release Candidate](https://img.shields.io/badge/-rc-mediumorchid) | string | The type of revision comparison. | `ahead`; `behind` [(see more)](#vcs-revision-delta-direction-values) |
...
| <a id="vcs-repository-ref-type" href="#vcs-repository-ref-type">`vcs.repository.ref.type`</a> | ![Deprecated](https://img.shields.io/badge/-deprecated-red)<br>Replaced by `vcs.ref.head.type`. | string | Deprecated, use `vcs.ref.head.type` instead. | `branch`; `tag` [(see more)](#vcs-repository-ref-type-values) |
