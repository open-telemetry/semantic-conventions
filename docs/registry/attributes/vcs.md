...
| <a id="vcs-line-change-type" href="#vcs-line-change-type">`vcs.line_change.type`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The type of line change being measured on a branch or change. | `added`; `removed` |
| <a id="vcs-owner-name" href="#vcs-owner-name">`vcs.owner.name`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The group owner within the version control system. | `my-org`; `myteam`; `business-unit` |
| <a id="vcs-provider-name" href="#vcs-provider-name">`vcs.provider.name`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The name of the version control system provider. | `github`; `gitlab`; `gitea`; `bitbucket` |
| <a id="vcs-ref-base-name" href="#vcs-ref-base-name">`vcs.ref.base.name`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The name of the [reference](https://git-scm.com/docs/gitglossary#def_ref) such as **branch** or **tag** in the repository. [1] | `my-feature-branch`; `tag-1-test` |
| <a id="vcs-ref-base-revision" href="#vcs-ref-base-revision">`vcs.ref.base.revision`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The revision, literally [revised version](https://www.merriam-webster.com/dictionary/revision), The revision most often refers to a commit object in Git, or a revision number in SVN. [2] | `9d59409acf479dfa0df1aa568182e43e43df8bbe28d60fcf2bc52e30068802cc`; `main`; `123`; `HEAD` |
| <a id="vcs-ref-base-type" href="#vcs-ref-base-type">`vcs.ref.base.type`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The type of the [reference](https://git-scm.com/docs/gitglossary#def_ref) in the repository. [3] | `branch`; `tag` |
| <a id="vcs-ref-head-name" href="#vcs-ref-head-name">`vcs.ref.head.name`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The name of the [reference](https://git-scm.com/docs/gitglossary#def_ref) such as **branch** or **tag** in the repository. [4] | `my-feature-branch`; `tag-1-test` |
| <a id="vcs-ref-head-revision" href="#vcs-ref-head-revision">`vcs.ref.head.revision`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The revision, literally [revised version](https://www.merriam-webster.com/dictionary/revision), The revision most often refers to a commit object in Git, or a revision number in SVN. [5] | `9d59409acf479dfa0df1aa568182e43e43df8bbe28d60fcf2bc52e30068802cc`; `main`; `123`; `HEAD` |
| <a id="vcs-ref-head-type" href="#vcs-ref-head-type">`vcs.ref.head.type`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The type of the [reference](https://git-scm.com/docs/gitglossary#def_ref) in the repository. [6] | `branch`; `tag` |
| <a id="vcs-ref-type" href="#vcs-ref-type">`vcs.ref.type`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The type of the [reference](https://git-scm.com/docs/gitglossary#def_ref) in the repository. | `branch`; `tag` |
| <a id="vcs-repository-name" href="#vcs-repository-name">`vcs.repository.name`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The human readable name of the repository. It SHOULD NOT include any additional identifier like Group/SubGroup in GitLab or organization in GitHub. [7] | `semantic-conventions`; `my-cool-repo` |
| <a id="vcs-repository-url-full" href="#vcs-repository-url-full">`vcs.repository.url.full`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The [canonical URL](https://support.google.com/webmasters/answer/10347851) of the repository providing the complete HTTP(S) address in order to locate and identify the repository through a browser. [8] | `https://github.com/opentelemetry/open-telemetry-collector-contrib`; `https://gitlab.com/my-org/my-project/my-projects-project/repo` |
| <a id="vcs-revision-delta-direction" href="#vcs-revision-delta-direction">`vcs.revision_delta.direction`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The type of revision comparison. | `ahead`; `behind` |
