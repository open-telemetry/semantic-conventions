...
| <a id="os-family" href="#os-family">`os.family`</a> | string[] | OS family (such as redhat, debian, freebsd, windows). [1] | `["android"]`; `["rhel"]`; `["fedora"]`; `["arch"]`; `["darwin"]`; `["ubuntu"]`; `["opensuse"]`; `["gentoo"]`; `["slackware"]` | ![Development](https://img.shields.io/badge/-development-blue) |
| <a id="os-id" href="#os-id">`os.id`</a> | string | A system generated id for the OS [2] | `android`; `centos`; `fedora`; `macos` | ![Development](https://img.shields.io/badge/-development-blue) |
...
**[1] `os.family`:** Theses values could also be an os.id
