...
| <a id="rpc-status-code" href="#rpc-status-code">`rpc.status_code`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | Status code of the RPC call. [6] | `OK`; `DEADLINE_EXCEEDED`; `-32602` |
