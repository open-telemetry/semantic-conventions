...
| <a id="rpc-request-header" href="#rpc-request-header">`rpc.request.header.<key>`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string[] | RPC request headers or metadata, `<key>` being the normalized header name (lowercase), the value being the header values. [2] | `["1.2.3.4", "1.2.3.5"]` |
| <a id="rpc-response-header" href="#rpc-response-header">`rpc.response.header.<key>`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string[] | RPC response headers or metadata sent before the response payload, `<key>` being the normalized header name (lowercase), the value being the header values. [3] | `["attribute_value"]` |
| <a id="rpc-response-trailer" href="#rpc-response-trailer">`rpc.response.trailer.<key>`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string[] | RPC response trailers or metadata sent after the response payload, `<key>` being the normalized trailer name (lowercase), the value being the trailer values. [4] | `["attribute_value"]` |
