...
**[2] `pprof.scope.default_sample_type`:** This attribute SHOULD be set at the scope level (resource_profiles[].scope_profiles[].scope.attributes[]).

**[3] `pprof.scope.sample_type_order`:** This attribute SHOULD be set at the scope level (resource_profiles[].scope_profiles[].scope.attributes[]).
