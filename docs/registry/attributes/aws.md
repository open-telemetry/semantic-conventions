...
| <a id="aws-ecs-launchtype" href="#aws-ecs-launchtype">`aws.ecs.launchtype`</a> | ![Development](https://img.shields.io/badge/-development-blue) | string | The [launch type](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/launch_types.html) for an ECS task. | `ec2`; `fargate` [(see all values)](#aws-ecs-launchtype-values) |
