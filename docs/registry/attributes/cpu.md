...
| --- | --- | --- | --- | --- |
| <a id="cpu-logical-number" href="#cpu-logical-number">`cpu.logical_number`</a> | ![Release Candidate](https://img.shields.io/badge/-rc-mediumorchid) | int | The logical CPU number [0..n-1] | `1` |
