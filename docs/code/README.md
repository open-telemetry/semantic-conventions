...
| [`code.line.number`](/docs/attributes-registry/code.md) | int | The line number in `code.file.path` best representing the operation. It SHOULD point within the code unit named in `code.function.name`. When using OTLP Profiles this attribute is covered my 'message Line' and MUST NOT be used. This constraint is imposed to prevent redundancy and maintain data integrity. | `42` | `Recommended` | ![Release Candidate](https://img.shields.io/badge/-rc-mediumorchid) |
