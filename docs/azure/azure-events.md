...
<!-- This section is maintained manually because schema v2 does not model event bodies, using bodies is not
recommended. -->
...
Using the event body is [not recommended](/docs/general/events.md#body).

<!-- TODO: Define attributes for individual body properties: https://github.com/open-telemetry/semantic-conventions/issues/1870 -->
