# Semantic Convetions for Azure Resource Log events
...
|---|---|---|---|---|---|
| `event.name` | string | Identifies the class / type of event. [1] | `az.resource.log` | ![Experimental](https://img.shields.io/badge/-experimental-blue) |
