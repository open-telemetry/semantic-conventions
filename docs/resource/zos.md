...
<!-- semconv refinement.zos.host -->
>>>>>>> dc68839b (Regegnerated documentation)
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
<!-- semconv refinement.zos.process -->
>>>>>>> dc68839b (Regegnerated documentation)
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Identity | [`process.pid`](/docs/registry/attributes/process.md) | ![Release Candidate](https://img.shields.io/badge/-rc-mediumorchid) | `Required` | int | Process identifier (PID). [1] | `2186` |
...
**[1] `process.pid`:** On z/OS, SHOULD be set to the Address Space Identifier (ASID), which uniquely identifies an address space within a single z/OS image. The ASID is typically represented as a four-digit hexadecimal value.
...
<!-- semconv refinement.zos.process.runtime -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
**type:** `refinement.zos.process.runtime`
...
The following table describes how to populate attributes on the `service` entity on mainframes.

<!-- semconv refinement.zos.service -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
| Role | Key | Stability | [Requirement Level](https://opentelemetry.io/docs/specs/semconv/general/attribute-requirement-level/) | Value Type | Description | Example Values |
| --- | --- | --- | --- | --- | --- | --- |
| Identity | [`service.name`](/docs/registry/attributes/service.md) | ![Stable](https://img.shields.io/badge/-stable-lightgreen) | `Required` | string | Logical name of the service. [1] | `CICS TS`; `Datacom`; `ADABAS` |
...
| Description | [`service.version`](/docs/registry/attributes/service.md) | ![Stable](https://img.shields.io/badge/-stable-lightgreen) | `Recommended` | string | The version string of the service component. The format is not defined by these conventions. [3] | `5.6` |

**[1] `service.name`:** For z/OS system software, SHOULD be set to an abbreviated name of the z/OS system software.
...
**[3] `service.version`:** For z/OS system software, SHOULD be set to the version of the z/OS system software.
...
| Value | Description | Stability |
| --- | --- | --- |
| `critical` | Service is business-critical; downtime directly impacts revenue, user experience, or core functionality. [4] | ![Alpha](https://img.shields.io/badge/alpha-mediumpurple) |
| `high` | Service is important but has degradation tolerance or fallback mechanisms. [5] | ![Alpha](https://img.shields.io/badge/alpha-mediumpurple) |
| `low` | Service is non-essential to core operations; used for background tasks or internal tools. [6] | ![Alpha](https://img.shields.io/badge/alpha-mediumpurple) |
| `medium` | Service provides supplementary functionality; degradation has limited user impact. [7] | ![Alpha](https://img.shields.io/badge/alpha-mediumpurple) |
...
The following table describes how to populate attributes on the `service.namespace` entity on mainframes.

<!-- semconv refinement.zos.service.namespace -->
<!-- NOTE: THIS TEXT IS AUTOGENERATED. DO NOT EDIT BY HAND. -->
<!-- see templates/registry/markdown/snippet.md.j2 -->
<!-- prettier-ignore-start -->
...
**type:** `refinement.zos.service.namespace`
...
| Role | Key | Stability | [Requirement Level](https://opentelemetry.io/docs/specs/semconv/general/attribute-requirement-level/) | Value Type | Description | Example Values |
| --- | --- | --- | --- | --- | --- | --- |
| Identity | [`service.namespace`](/docs/registry/attributes/service.md) | ![Stable](https://img.shields.io/badge/-stable-lightgreen) | `Required` | string | A namespace for `service.name`. [1] | `CICSPLX2` |

**[1] `service.namespace`:** For z/OS system software, SHOULD be set to the identifier representing a grouping of z/OS system software instances, e.g., the name of the CICSPLEX.
<!-- prettier-ignore-end -->
<!-- END AUTOGENERATED TEXT -->
<!-- endsemconv -->
