...
| [`k8s.container.ports`](/docs/registry/attributes/k8s.md) | int[] | List of ports to expose from the container. | `[10053]`; `[8080, 8081]` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
