...
| Description | [`k8s.hpa.annotation.<key>`](/docs/registry/attributes/k8s.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | string | The annotation key-value pairs placed on the HorizontalPodAutoscaler. [4] | `4`; `` |
| Description | [`k8s.hpa.label.<key>`](/docs/registry/attributes/k8s.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Opt-In` | string | The label key-value pairs placed on the HorizontalPodAutoscaler. [5] | `weekly`; `` |
...
**[4] `k8s.hpa.annotation.<key>`:** The `<key>` being the annotation name, the value being the annotation value, even if the value is empty.

**[5] `k8s.hpa.label.<key>`:** The `<key>` being the label name, the value being the label value, even if the value is empty.
<!-- prettier-ignore-end -->
<!-- END AUTOGENERATED TEXT -->
<!-- endsemconv -->
