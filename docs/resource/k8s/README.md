...
| Description | [`k8s.namespace.name`](/docs/registry/attributes/k8s.md) | ![Beta](https://img.shields.io/badge/beta-lightpink) | `Recommended` | string | The namespace of the bound PersistentVolumeClaim. Only available when the PV is in the `Bound` phase. | `default` |
...
| Description | [`k8s.persistentvolumeclaim.name`](/docs/registry/attributes/k8s.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | The name of the bound PersistentVolumeClaim. Only available when the PV is in the `Bound` phase. | `pvc-data-01` |
...
| Description | [`k8s.persistentvolume.name`](/docs/registry/attributes/k8s.md) | ![Development](https://img.shields.io/badge/-development-blue) | `Recommended` | string | The name of the bound PersistentVolume. Only available when the PVC is in the `Bound` phase. | `pv-data-01` |
