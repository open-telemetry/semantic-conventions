...
| [`container.label.<key>`](/docs/attributes-registry/container.md) | string | Container labels, `<key>` being the label name, the value being the label value. | `nginx` | `Recommended` | ![Development](https://img.shields.io/badge/-development-blue) |
