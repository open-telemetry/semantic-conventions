...
| `openai.azure.chat_completions.response.filter_results` | string[] | Array of results that were filtered out. | `[[1]: self_harm, [2]: violence, hate]` | Conditionally Required: if and only if some content was filtered |
