...
PREVIOUS_SPECIFICATION_VERSION="1.19.0"
...
fix_file() {
  echo Fixing file $1
  sed -i "s,${SPECIFICATION_URL_PREFIX}${PREVIOUS_SPECIFICATION_VERSION},${SPECIFICATION_URL_PREFIX}${PREVIOUS_SPECIFICATION_VERSION},g" $1
}
